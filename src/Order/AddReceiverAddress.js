        ...
        <div className="grid md:grid-cols-2 gap-2 text-[12px] text-gray-700">
          <div>
            ...
            <input
              ...
              className="w-full border font-[600] rounded-lg px-3 py-2 text-[12px]  outline-none focus:ring-1 focus:ring-[#0192ED]"
              required
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              placeholder="receiver.contact@delightcargo.in"
              className="w-full border font-[600] rounded-lg px-3 py-2 text-[12px]  outline-none focus:ring-1 focus:ring-[#0192ED]"
              required
            />
          </div>
