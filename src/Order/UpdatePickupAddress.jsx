                ...
                <form className="grid grid-cols-2 mt-2 gap-2 text-[12px] font-[600] text-gray-700">
                    <div className="flex flex-col gap-1">
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 rounded-lg border outline-none focus:ring-1 focus:ring-[#0192ED]"
                        />
                    </div>
                    <div className="flex flex-col gap-1">
                        <label className="block">
                    ...
                    <div className="col-span-2 text-right flex gap-2 justify-end">
                        ...
                        <button
                            ...
                            className="bg-[#0192ED] text-white px-3 py-2 rounded-lg hover:opacity-90 transition text-[12px]"
                        >
                            Save
                        </button>
