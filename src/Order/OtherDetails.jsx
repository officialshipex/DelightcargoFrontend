...
const OtherDetails = ({ amount, otherDetails, setOtherDetails }) => {
    ...
    return (
        <div className="border border-[#0192ED] flex flex-col mt-4 rounded-lg p-4 bg-white hover:shadow-sm transition-shadow">
            ...
            <div className="flex sm:flex-row flex-col gap-2 font-[600] text-[12px] text-gray-700 sm:w-3/6 w-full">
                ...
                <div className="w-full ">
                    ...
                    <input
                        ...
                        className="w-full border rounded-lg px-3 py-2 text-[12px] outline-none focus:ring-1 focus:ring-[#0192ED]"
                ...
                <div className="w-full">
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        className="w-full border rounded-lg px-3 py-2 outline-none focus:ring-1 focus:ring-[#0192ED]"
                ...
                <div className="w-full">
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        className={`w-full border rounded-lg px-3 py-2 text-[12px] outline-none focus:ring-1 focus:ring-[#0192ED] ${isEwaybillRequired ? "border-red-500" : ""
                            }`}
