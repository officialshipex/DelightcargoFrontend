    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-[1000] animate-in fade-in duration-300">
      <div className="bg-white p-4 rounded-lg shadow-sm w-[500px] relative animate-popup-in border border-gray-100">
        ...
        <div className="bg-gray-50 border border-gray-100 rounded-lg px-3 py-2 mb-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-[#0192ED] hover:underline flex items-center gap-1.5 text-[10px] sm:text-[12px] font-bold transition-all"
            >
        ...
        <div className="space-y-2">
          <label className="group cursor-pointer block relative">
            <div className={`
              ...
              ${selectedFile ? 'border-[#0192ED] bg-blue-50/30' : 'border-gray-200 hover:border-[#0192ED] hover:bg-gray-50'}
            `}>
              <div className={`p-4 rounded-full mb-3 transition-colors ${selectedFile ? 'bg-[#0192ED] text-white' : 'bg-gray-100 text-gray-400 group-hover:bg-blue-100 group-hover:text-[#0192ED]'}`}>
                <FaUpload size={16} />
              </div>
        ...
        <div className="flex justify-between items-center mt-8 gap-3">
          <button
            onClick={onBack}
            className="flex items-center justify-center bg-gray-50 border border-gray-200 px-3 py-2 rounded-lg gap-2 text-[10px] sm:text-[12px] font-bold text-gray-600 hover:text-[#0192ED] hover:border-[#0192ED] hover:bg-blue-50 transition-all"
          >
            <FaArrowLeft size={12} />
            Back
          </button>
          ...
          <button
            ...
            className="flex py-2 px-3 bg-[#0192ED] text-white rounded-lg text-[10px] sm:text-[12px] font-bold hover:opacity-90 transition-all flex items-center justify-center gap-2"
          >
            Confirm & Upload
          </button>
        </div>
