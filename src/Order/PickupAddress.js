      ...
      >
        <div>
          ...
          <input
            ...
            className="w-full m-1 px-3 py-2 text-[12px] font-[600] border rounded-lg focus:outline-none focus:ring-1 focus:ring-[#0192ED]"
          />
        </div>
        <div>
          <label className="block font-[600] text-[12px]">
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="Seller.contact@delightcargo.com"
            className="w-full m-1 px-3 py-2 text-[12px] font-[600] border rounded-lg focus:outline-none focus:ring-1 focus:ring-[#0192ED]"
          />
        </div>
        <div>
        ...
        <div className="col-span-2 text-right">
          <button
            type="submit"
            className="bg-[#0192ED] font-[600] text-[12px] text-white px-3 py-2 hover:opacity-90 transition rounded-lg"
          >
            Save
          </button>
        </div>
