            ...
            <div className="bg-white p-2 rounded-lg shadow-sm mb-2 sticky z-40">
                <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="px-2 font-[600] py-1 rounded text-[10px] bg-blue-100 text-[#0192ED]">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="relative" ref={headerActionRef}>
                            <button
                                ...
                                className="p-2 bg-gray-100 rounded-lg hover:bg-blue-50 transition-colors"
                            >
            ...
            <div className="md:hidden w-full">
                <div className="flex items-center justify-between gap-2 mb-2 bg-white p-2 rounded-lg shadow-sm border border-gray-100">
                    ...
                    <div className="relative" ref={mobileActionRef}>
                        ...
                        >
                            <FiMoreHorizontal className={selectedOrders.length === 0 ? "text-gray-400" : "text-[#0192ED]"} />
