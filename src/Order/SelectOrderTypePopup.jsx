    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm z-[1000] animate-in fade-in duration-300">
      <div className="bg-white p-6 rounded-lg shadow-lg w-[400px] text-left">
        ...
        <div className="flex gap-4 justify-center mt-4">
          <button
            className="px-3 py-2 text-[10px] sm:text-[12px] bg-[#0192ED] text-white rounded-lg hover:opacity-90 font-[600]"
          ...
          <button
            className="px-3 py-2 bg-[#0192ED] text-white text-[10px] sm:text-[12px] rounded-lg hover:opacity-90 font-[600]"
