...
const ProductDetailsSection = ({ order, onUpdate }) => {
                    ...
                    <div className="bg-white rounded-lg shadow-lg w-full max-w-5xl max-h-[90vh] overflow-y-auto m-4 animate-popup-in">
                        <div className="sticky top-0 bg-white border-b py-2 px-3 flex justify-between items-center z-10">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    onClick={handleSave}
                                    className="px-3 py-2 bg-[#0192ED] text-white rounded-lg text-[10px] sm:text-[12px] font-[600] hover:opacity-90"
                                >
                                    Save Changes
                                </button>
                            </div>
                        ...
                        <div className="px-3 py-4">
                            {products.map((product, index) => (
                                ...
                                >
                                    {/* Number Badge */}
                                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-[#0192ED] text-white sm:w-8 sm:h-8 w-6 h-6 flex justify-center items-center rounded-full text-[12px] font-[600] shadow">
                                        {index + 1}
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-2 mt-2 font-[600] text-gray-700">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full border rounded-lg px-3 py-2 sm:text-[12px] text-[10px] focus:outline-[#0192ED]"
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full pl-7 border rounded-lg px-3 py-2 sm:text-[12px] text-[10px] focus:outline-[#0192ED]"
                                    ...
                                    >
                                        {/* Arrow Icon */}
                                        <ChevronDown
                                            className={`w-4 h-4 text-[#0192ED] transition-transform duration-300
  ...
  `}
                                        ...
                                        {/* Text */}
                                        <span className="text-[#0192ED] sm:text-[12px] text-[10px] font-[600]">
                            ...
                            <button
                                onClick={addProduct}
                                className="flex items-center justify-center sm:w-8 sm:h-8 w-6 h-6 bg-[#0192ED] text-white rounded-full mx-auto hover:opacity-90"
                            >
                                +
                            </button>

                            {/* Total Display */}
                            <div className="mt-2 px-3 py-2 bg-blue-100 rounded-lg flex justify-between items-center">
                                <span className="sm:text-[12px] text-[10px] font-[600] text-gray-700">Total Amount</span>
                                <span className="sm:text-[12px] text-[10px] font-[600] text-[#0192ED]">₹ {calculateTotal()}</span>
                            </div>
                        </div>
                    </div>
                </div>
