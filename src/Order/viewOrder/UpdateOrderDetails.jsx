      ...
      >
        ...
        <div>
          ...
          <select
            ...
            className="w-full h-9 px-3 rounded-lg border focus:outline-[#0192ED]"
          >
        ...
        {order?.orderType !== "B2B" && (
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full py-2 px-3 rounded-lg border-2 focus:outline-[#0192ED]"
              step="0.01"
            />
          </div>
        )}
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className="w-full py-2 px-3 font-[600] rounded-lg border focus:outline-[#0192ED]"
            step="0.01"
          />
        </div>
          ...
          <>
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full h-9 px-3 rounded-lg border-2 focus:outline-blue-200"
                step="0.1"
              />
            </div>
        ...
        <div className="col-span-1 sm:col-span-2 md:col-span-3 text-right mt-2">
          <button
            type="submit"
            className="bg-[#0192ED] text-white px-3 py-2 rounded-lg hover:opacity-90 transition"
          >
            Save
          </button>
        </div>
