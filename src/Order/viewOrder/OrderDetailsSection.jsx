    ...
    return (
        <div className="bg-white p-4 rounded-lg shadow-sm">
            <div className="flex items-center gap-2 mb-2 border-b pb-2">
                <p className="p-2 bg-blue-100 hidden sm:block rounded-full"><FileText className="w-4 h-4 text-[#0192ED]" /></p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 font-[600] gap-2 text-[10px] sm:text-[12px]">
                ...
                <div className="flex flex-col items-start">
                    ...
                    <div className="flex items-center gap-1">
                        {/* Channel badge */}
                        <span className="inline-flex items-center px-2 rounded bg-blue-100 text-[#0192ED] text-[10px] uppercase">
