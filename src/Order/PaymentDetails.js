...
const PaymentDetails = ({ packageData, initialData, userId, updateId }) => {
  ...
  return (
    <div>
      <div className="border mt-2 border-[#0192ED] rounded-lg p-4 bg-white hover:shadow-sm transition-shadow">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:space-x-4">
            <div className="flex items-center space-x-2">
              <input
                ...
                className="h-4 w-4 appearance-none rounded-full border-2 border-[#0192ED] checked:bg-[#0192ED] focus:outline-none cursor-pointer"
              />
        ...
        >
          <span className="text-[#0192ED] hover:underline text-left hover:text-blue-500 text-[12px] font-[600]">
            <span className="text-[#0192ED] hover:underline hover:text-blue-500 text-[12px] font-[600]">
              +
            </span>
            ...
            {[
              ...
              return (
                <div key={key} className="flex flex-col">
                  ...
                  {/* Input Wrapper */}
                  <div className="flex items-center border rounded-lg overflow-hidden focus-within:ring-1 focus-within:ring-[#0192ED] focus-within:border-[#0192ED]">
                    <input
                      type="number"
                      name={key}
                      value={fees[key] || ""}
      ...
      <div className="flex justify-end my-2">
        <button
          ...
          className="bg-[#0192ED] font-[600] hover:bg-blue-500 text-white text-[12px] px-3 py-2 rounded-lg shadow-sm"
        >
