...
const ProductDetails = ({ Address, initialData, userId, updateId }) => {
    ...
    return (
        <div className="max-w-full mx-auto">
            <div className="border border-[#0192ED] rounded-lg p-4 bg-white hover:shadow-sm transition-shadow">
                ...
                {products.map((product, index) => (
                    <div
                        key={product.id}
                        className="border border-dashed border-[#0192ED] rounded-lg p-4 mb-6 relative bg-white"
                    >
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 font-[600] text-gray-700 gap-2">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full border focus:outline-[#0192ED] rounded-lg px-3 py-2 text-[12px]"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full border rounded-lg focus:outline-[#0192ED] px-3 py-2 text-[12px]"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-7 border focus:outline-[#0192ED] rounded-lg px-3 py-2 text-[12px]"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            <span className="text-[#0192ED] text-[12px] font-[600]">
                        ...
                        {showAdditionalFees && (
                            <div className="grid grid-cols-2 font-[600] md:grid-cols-4 gap-2 mt-4">
                                <input className="border rounded-lg px-3 py-2 text-[12px] focus:outline-[#0192ED]" type="text" placeholder="Product Category" onChange={(e) => handleInputChange(product.id, "category", e.target.value)} value={product.category} />
                                <input className="border rounded-lg px-3 py-2 text-[12px] focus:outline-[#0192ED]" type="text" placeholder="SKU" onChange={(e) => handleInputChange(product.id, "sku", e.target.value)} value={product.sku} />
                                <input className="border rounded-lg px-3 py-2 text-[12px] focus:outline-[#0192ED]" type="text" placeholder="Discount" onChange={(e) => handleInputChange(product.id, "discount", e.target.value)} value={product.discount} />
                                <input className="border rounded-lg px-3 py-2 text-[12px] focus:outline-[#0192ED]" type="text" placeholder="Tax" onChange={(e) => handleInputChange(product.id, "tax", e.target.value)} value={product.tax} />
                            </div>
                        )}
                    </div>
                ))}
                ...
                <button
                    onClick={addProduct}
                    className="flex items-center justify-center w-8 h-8 bg-[#0192ED] text-white rounded-full mx-auto"
                >
                    +
                </button>
            </div>
