...
const OverviewWeightDisputeSection = ({ selectedUserId }) => {
  ...
  const StatBox = ({ label, value, icon: Icon, onClick }) => (
    <div
      className="flex items-center border border-gray-200 cursor-pointer bg-white rounded-lg p-3 shadow-sm hover:border-[#0192ED] transition-all duration-700 w-full"
      onClick={onClick}
    >
      {Icon && (
