...
const AnnouncementItem = ({ ann, idx, setAnnouncements, announcements }) => {
    ...
    return (
        <div className="flex items-center justify-between border-2 border-[#0192ED] bg-blue-50 rounded-lg px-3 py-2 mb-2 shadow-sm w-full max-w-full gap-3 overflow-hidden">
            <div className="flex items-center gap-3 flex-1 overflow-hidden">
                <FiBell className="text-[#0192ED] text-[16px] sm:text-[18px] flex-shrink-0" />
                        ...
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={`px-3 py-2 text-[12px] border font-[600] rounded-lg transition-all duration-200 ${activeTab === tab
                                    ...
                                    : "text-gray-500 bg-white hover:bg-blue-100"
                                    }`}
                            >
                                {tab}
                            </button>
