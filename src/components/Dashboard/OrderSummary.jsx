                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    {summaryData.map((item, index) => (
                        <div
                            ...
                            className="flex flex-col justify-between rounded-lg p-4 shadow-sm border border-gray-200 hover:border-[#0192ED] cursor-pointer transition-all duration-700"
                        >
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-lg flex items-center justify-center text-[16px] bg-[#0192ED] text-white">
                                    {item.icon}
                                </div>
