  ...
  const cardData = [
    {
      ...
      icon: <FaClipboardList className="text-sm text-[#0192ED]" />,
    },
    {
      title: "Revenue",
      value: `₹${dashdata?.totalRevenue ?? 0}`,
      icon: <FaRupeeSign className="text-sm text-[#0192ED]" />,
    },
    {
      title: "Avg Shipping",
      value: `₹${dashdata?.averageShipping ?? 0}`,
      icon: <FaBox className="text-sm text-[#0192ED]" />,
    },
  ];
    ...
    <div className="min-h-screen p-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        {cardData.map((card, index) => (
          <div
            key={index}
            className="text-gray-500 bg-[#0192ED] p-6 rounded-lg border-1 border-gary-500 shadow-md flex items-center space-x-0"
          >
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-3 md:gap-3 ">
              {stat.data.map((item, i) => (
                <div
                  key={i}
                  className="bg-[#0192ED] p-4 md:p-5 border-1 border-gray-800 rounded-lg shadow-md flex flex-col justify-center items-center text-center"
                >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pt-4">
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-rows-3 gap-4 text-sm">
          {/* Total Orders */}
          <div className="flex items-center p-5 bg-[#0192ED] shadow-md rounded-lg text-white">
          ...
          {/* Pending Orders */}
          <div className="flex items-center p-5 bg-[#0192ED] shadow-md rounded-lg border text-white">
            <div className="bg-white rounded-full p-2 mr-5">
