            ...
            >
                ...
                <div className="relative mb-2">
                    <input
                        ...
                        className="border rounded-lg px-3 py-2 w-full text-[12px] sm:text-[14px] outline-none focus:ring-1 focus:ring-[#0192ED] pr-10"
                        required
                    />
                    <span
                        onClick={() => setShowNewPassword((prev) => !prev)}
                        className="absolute right-3 top-2.5 cursor-pointer text-gray-500 hover:text-[#0192ED]"
                    >
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="bg-[#0192ED] text-white text-[12px] sm:text-[14px] w-full px-3 py-2 rounded-lg font-[600] hover:bg-[#0ba76e] transition disabled:opacity-70"
                >
                    {loading ? "Saving..." : "Save"}
                </button>
