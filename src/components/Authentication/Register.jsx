...
import DelightCargoLogo from "../../assets/DelightCargo.jpg";
...
export default function Signup({ setIsAuthenticated }) {
  ...
  return (
    <div className="flex-col md:flex-row bg-blue-50 flex-grow page-slide-in">
      <div className="w-full flex flex-row px-2 py-6 md:p-6 justify-center items-center">
        <div className="w-full max-w-sm md:max-w-md lg:max-w-xl p-4 md:p-6 rounded-lg shadow-sm bg-white">
          <div className="flex justify-between items-center mb-2">
            ...
            <Link to="/login" className="text-[12px] font-[600] text-[#0192ED]">
              &lt; <strong>Back</strong>
            </Link>
          </div>
          ...
          <form className="space-y-2" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              ...
              <span
                ...
                className="absolute right-3 top-[34px] cursor-pointer text-[#0192ED]"
              >
            ...
            <div className="flex items-start gap-2">
              <input
                ...
                className="accent-[#0192ED] mt-2.5 cursor-pointer"
              />
              <label className="text-[10px] text-gray-700 font-[600] my-2">
                By clicking this check box, you accept DelightCargo&apos;s{" "}
                <a href="#" className="text-[#0192ED] underline">
                  Terms & Conditions
                </a>{" "}
                &{" "}
                <a href="#" className="text-[#0192ED] underline">
      ...
      <div className="w-full bg-white">
        <footer className="w-full bg-blue-50 font-[600] px-3 py-2 flex flex-col sm:flex-row sm:justify-between sm:items-center text-gray-500 text-[10px] text-center sm:text-left sm:space-y-0">
