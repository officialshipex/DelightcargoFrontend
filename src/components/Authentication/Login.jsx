...
const LoginPage = ({ setIsAuthenticated }) => {
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden page-slide-in">
      {/* Main Content */}
      <div className="flex flex-col md:flex-row bg-blue-50 flex-grow">
        {/* Left Section */}
        <div className="w-full px-4 py-6 md:p-6 flex justify-center items-center">
          <div className="w-full max-w-sm md:max-w-md p-4 md:p-6 rounded-lg shadow-sm bg-white">
            ...
            <div className="flex justify-start mb-4 md:mb-4">
              <img src={DelightCargoLogo} alt="Logo" className="h-10 md:h-12" />
            </div>

            {/* Heading */}
            <h1 className="text-[18px] md:text-[24px] font-[600] mb-2 md:mb-3 text-left text-[#0192ED]">
              Welcome Back!
            </h1>
            ...
            <form className="space-y-2" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  className="border rounded-lg px-3 py-2 w-full text-[12px] font-[600] text-gray-700 outline-none focus:ring-1 focus:ring-[#0192ED]"
                />
                {error.email && (
              ...
              <div>
                <label className="w-full text-[12px] font-[600] flex justify-end">
                  <span
                    ...
                    className="text-[12px] text-[#0192ED] hover:underline cursor-pointer"
                  >
                    Forgot Password?
                  </span>
                </label>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="border rounded-lg px-3 py-2 w-full pr-10 text-[12px] font-[600] text-gray-700 outline-none focus:ring-1 focus:ring-[#0192ED]"
                  />
                  <span
                    onClick={togglePasswordVisibility}
                    className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-[#0192ED]"
                  >
              ...
              <div className="flex items-center space-x-2">
                <input type="checkbox" className="h-3 w-3 accent-[#0192ED] cursor-pointer" />
              ...
              <button
                ...
                className={`py-2 px-3 text-[12px] font-[600] rounded-lg w-full mt-4 transition ${isLoading
                  ...
                  : "bg-[#0192ED] text-white hover:bg-opacity-90"
                  }`}
              >
                {isLoading ? (
              ...
              <p className="text-[10px] font-[600] text-gray-500 text-left mt-3">
                ...
                <Link
                  to="/register"
                  className="text-[#0192ED] underline hover:font-[600] hover:text-[#0192ED]"
                >
                  Create new account
                </Link>
              </p>
        ...
        <div className="sm:flex justify-center items-center mt-44 hidden md:block">
          <div className="relative w-[350px] h-[350px] flex items-center justify-center md:mr-60 mr-0 md:scale-100 scale-[0.65]">
            ...
            <div className="w-[180px] h-[180px] rounded-full border border-bg-[#0192ED] bg-white flex items-center justify-center text-center px-4">
            ...
            <div className="absolute -top-5 left-1/2 transform -translate-x-1/2 text-center">
              ...
              <div className="bg-[#0192ED] text-white w-10 h-10 rounded-full flex items-center justify-center font-[600] text-[12px] shadow-md mt-3">1</div>
            </div>
            ...
            <div className="absolute top-1/2 right-[-40px] transform -translate-y-1/2 text-center">
              <div className="flex flex-row items-center -ml-[70px]">
                <div className="bg-[#0192ED] text-white w-10 h-10 rounded-full flex items-center justify-center font-[600] text-[12px] shadow-sm ml-2">
                  2
                </div>
            ...
            <div className="absolute -bottom-14 left-1/2 transform -translate-x-1/2 text-center w-28">
              <div className="bg-[#0192ED] text-white w-10 h-10 rounded-full flex items-center justify-center font-[600] text-[12px] shadow-sm mx-auto">3</div>
            ...
            <div className="absolute top-1/2 -left-11 transform -translate-y-1/2 text-center">
              <div className="flex flex-row items-center -ml-[70px]">
                ...
                <div className="bg-[#0192ED] text-white w-10 h-10 rounded-full flex items-center justify-center font-[600] text-[12px] shadow-sm mx-auto">
                  4
                </div>
              </div>
            </div>
      ...
      <div className="w-full bg-white">
        <footer className="w-full bg-blue-50 px-4 py-4 flex flex-col sm:flex-row sm:justify-between sm:items-center text-gray-500 text-[10px] text-center sm:text-left space-y-2 sm:space-y-0 ">
          <p className="w-full sm:w-auto font-[600]">
            © 2025 DelightCargo. All rights reserved.
          </p>

          <div className="sm:flex flex-col font-[600] sm:flex-row sm:space-x-4 space-y-1 sm:space-y-0 w-full sm:w-auto hidden md:block">
            <a href="https://www.delightcargo.com/privacy-policy" target="blank" className="text-gray-500 hover:text-gray-900">
              Privacy Policy
            </a>
            <a href="https://www.delightcargo.com/refund-cancellation" target="blank" className="text-gray-500 hover:text-gray-900">
              Refund & Cancellation Policy
            </a>
            <a href="https://www.delightcargo.com/terms-conditions" target="blank" className="text-gray-500 hover:text-gray-900">
              Terms & Conditions
            </a>
          </div>
        </footer>
