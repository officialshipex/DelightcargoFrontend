      ...
      <div className="p-4 space-y-2">
        <div className="relative">
          ...
          <div
            ...
            className="flex items-center justify-between font-[600] border border-gray-300 bg-white px-3 py-1.5 h-10 rounded-lg cursor-pointer hover:border-[#0192ED] transition-all group"
          >
            ...
            <FiChevronDown className={`text-gray-400 group-hover:text-[#0192ED] transition-transform flex-shrink-0 ${isDropdownOpen ? "rotate-180" : ""}`} />
          </div>
            ...
            <div className="absolute font-[600] top-full left-0 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-[100] animate-in fade-in slide-in-from-top-2 max-h-44 overflow-y-auto">
              {services.map((service, idx) => (
                <div
                  ...
                  className={`px-4 py-2.5 text-[12px] sm:text-[13px] border-b border-gray-50 last:border-0 hover:bg-[#0192ED]/5 hover:text-[#0192ED] cursor-pointer transition-colors flex items-center justify-between ${selectedService?.courierServiceName === service.courierServiceName ? 'bg-[#0192ED]/10 text-[#0192ED]' : 'text-gray-700'}`}
                >
                  ...
                  {service.status === "Active" ? (
                    <div className="w-2 h-2 rounded-full bg-[#0192ED]"></div>
                  ) : (
        ...
        {selectedService && currentData && (
          <div className="animate-in fade-in slide-in-from-top-1 duration-300 space-y-5 pt-2">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100">
              ...
              <div className="flex items-center gap-2">
                <span className={`text-[10px] font-bold ${selectedService.status === 'Active' ? 'text-[#0192ED]' : 'text-gray-400'}`}>
            ...
            <div className="space-y-2">
              ...
              <div className="border-t border-gray-100 pt-4 flex flex-col sm:flex-row items-end gap-3">
                ...
                <button
                  className={`h-9 px-6 rounded-lg text-white font-[600] text-[10px] sm:text-[12px] flex items-center justify-center gap-2 transition-all shadow-sm w-full sm:w-auto ${editedRates[selectedService.courierServiceName] ? 'bg-[#0192ED] hover:bg-blue-600' : 'bg-gray-300 cursor-not-allowed'}`}
          ...
          return (
            <div key={provider} className="flex items-center justify-between pb-2 border-b border-gray-50 last:border-0 last:pb-0">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div className={`w-9 h-5 rounded-full transition-colors ${isAllEnabled ? 'bg-[#0192ED]' : isSomeEnabled ? 'bg-yellow-400' : 'bg-gray-300'}`}></div>
