    ...
    <div className="fixed inset-0 animate-popup-in bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white p-6 rounded-lg w-full max-w-md shadow-2xl">
        ...
        <input
          ...
          className={`w-full border ${error ? "border-red-500" : "border-gray-300"} rounded-lg px-3 py-2 text-[12px] sm:text-[14px] focus:outline-none focus:ring-2 focus:ring-[#0192ED] focus:border-transparent`}
        ...
        <div className="flex justify-end gap-2 mt-4">
          ...
          <button
            onClick={handleSave}
            className="px-3 py-2 rounded-lg bg-[#0192ED] text-white hover:bg-opacity-90 text-[10px] sm:text-[12px] font-[600] transition-colors"
          >
            Update Password
          </button>
        </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between px-4 py-2 bg-gray-50 border-b border-gray-200 gap-2">
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  <button
                    ...
                    className="bg-[#0192ED] text-white px-3 py-1.5 rounded-lg text-[10px] font-bold hover:bg-blue-600 transition-colors"
                  >
                    Add Rate Card
                  </button>
                  <button
              ...
              <div className="p-4 sm:p-4 space-y-2 sm:space-y-2">
                {[
                  ...
                  },
                  {
                    label: "KYC Status",
                    value: (
                      <span className={`inline-flex items-center gap-1.5 text-[10px] font-[600] ${userData?.kycStatus ? "text-[#0192ED]" : "text-yellow-700"}`}>
                        {userData?.kycStatus ? (
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {!!admin && (
                          <button
                            ...
                            className="text-[#0192ED] hover:text-blue-500"
                          >
                            <FiEdit size={12} />
                          </button>
                        )}
                  ...
                  { label: "Referral Code", value: userData?.referralCode || "N/A" },
                  {
                    ...
                    value: admin ? (
                      <button
                        ...
                        className="text-[#0192ED] hover:text-blue-500 flex items-center gap-1 font-[600]"
                      >
                        <Settings size={14} />
                        Change
                      </button>
                ...
                {!!admin && !!userData?.referralCommissionPercentage && (
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button onClick={() => setShowReferralModal(true)} className="text-[#0192ED] hover:text-blue-500">
                        <FiEdit size={12} />
                      </button>
                    </div>
                  </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button onClick={() => setShowCreditLimitModal(true)} className="text-[#0192ED] hover:text-blue-500">
                      <FiEdit size={12} />
                    </button>
                  </div>
                </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <label className="relative inline-flex items-center cursor-pointer">
                            <input
                              ...
                              className="sr-only peer"
                            />
                            <div className="w-11 h-6 bg-gray-300 rounded-full peer peer-checked:bg-[#0192ED] transition-colors"></div>
                            <div className="absolute left-1 top-1 bg-white w-4 h-4 rounded-full peer-checked:translate-x-5 transition-transform shadow-md"></div>
                          </label>
                        </div>
                      </div>
