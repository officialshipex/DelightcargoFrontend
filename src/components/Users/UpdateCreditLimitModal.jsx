    ...
    <div className="fixed animate-popup-in inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white p-4 rounded-lg w-full max-w-md shadow-2xl">
        ...
        <input
          ...
          className="w-full border border-gray-300 rounded-lg px-3 py-2 text-[12px] sm:text-[14px] focus:outline-none focus:ring-2 focus:ring-[#0192ED]"
        ...
        <div className="flex justify-end gap-3 mt-4">
          ...
          <button
            onClick={handleSave}
            className="px-3 py-2 rounded-lg bg-[#0192ED] text-white hover:bg-blue-500 text-[10px] font-[600] sm:text-[12px]"
          >
            Save
          </button>
        </div>
