...
const PassbookHistoryForm = ({ onClose }) => {
    ...
    return (
        <div className="max-w-lg mx-auto mt-10 bg-white rounded-lg shadow-sm border border-[#0192ED] p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            >
                                {["debit", "credit"].map((type) => (
                                    <li
                                        ...
                                        className={`py-2 px-3 text-[12px] cursor-pointer hover:bg-blue-50 ${formData.transactionType === type ? "font-bold bg-blue-100" : ""
                                            }`}
                ...
                <div className="flex flex-col">
                            ...
                            <button
                                ...
                                className={`text-[10px] px-2 py-1 rounded border transition-colors ${
                                    formData.description === suggestion
                                        ? "bg-blue-100 border-[#0192ED] text-[#0192ED] font-bold"
                    ...
                    <textarea
                        ...
                        className="resize-none w-full px-3 py-2 border-2 border-gray-300 rounded-lg text-gray-700 placeholder:text-gray-400 focus:outline-none focus:border-[#0192ED] font-[600] text-[12px]"
                    ></textarea>
                </div>
                ...
                <div className="flex space-x-2">
                    <button
                        type="submit"
                        className="flex bg-[#0192ED] font-[600] text-[10px] sm:text-[12px] text-white py-2 px-3 rounded-lg hover:bg-[#0aa76f]"
