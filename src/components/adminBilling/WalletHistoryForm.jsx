...
const WalletHistoryForm = ({ onClose }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row max-w-4xl mx-auto mt-10 bg-white rounded-lg shadow-sm border border-[#0192ED]">
      {/* Left Side Image */}
        ...
        <div className="flex mb-4 border-b">
          <button
            ...
            className={`px-4 py-2 font-semibold text-sm 
              ${activeTab === "recharge" ? "text-[#0192ED] border-b-2 border-[#0192ED]" : "text-gray-500"}
            `}
          >
            Recharge
          </button>
          <button
            ...
            className={`px-4 py-2 font-semibold text-sm 
              ${activeTab === "updation" ? "text-[#0192ED] border-b-2 border-[#0192ED]" : "text-gray-500"}
            `}
          >
            Updation
          </button>
