            ...
            <div className="md:w-full w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-2">
                    ...
                    <div className="flex space-x-2">
                        <button
                            type="submit"
                            className={`flex font-[600] text-[10px] sm:text-[12px] text-white py-2 px-3 rounded-lg ${selectedUserId ? "bg-[#0192ED] hover:bg-[#0aa76f]" : "bg-gray-400 cursor-not-allowed"}`}
