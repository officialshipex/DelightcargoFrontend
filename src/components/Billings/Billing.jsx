    ...
    <div className="sm:px-2 w-full">
          ...
          <div className="flex flex-row sm:flex-col w-full gap-2">
            <div className="w-full sm:w-full">
              <button
                ...
                className="w-full bg-[#0192ED] mb-2 sm:mb-0 text-white font-[600] px-3 py-2 rounded-lg text-[10px]"
              >
                Early COD
              </button>
            </div>
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full md:w-6/12 mb-2">
        ...
        <div className="flex gap-2 w-full">
          {/* Wallet Balance Box */}
          <div className="flex flex-row w-full bg-white text-gray-700 rounded-lg gap-2 px-2 h-14 items-center justify-start text-[12px] border border-[#0192ED]">
        ...
        <div className="flex gap-2 w-full">
          ...
          {/* Usable Balance Box */}
          <div className="flex flex-row w-full bg-white text-gray-700 rounded-lg gap-2 px-3 py-2 items-center justify-start text-[12px] border border-[#0192ED]">
            <div className="p-2 rounded-full flex justify-center items-center bg-[#0192ED] text-white">
        ...
        {showDropdown && (
          <div className="absolute top-full left-0 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg z-[100] overflow-hidden animate-popup-in max-h-80 overflow-y-auto">
            {tabs.map((tab) => (
              <button
                key={tab}
                className={`w-full text-left px-4 py-2 text-[12px] font-[600] transition-colors ${selectedItem === tab ? "bg-blue-50 text-[#0192ED]" : "text-gray-700 hover:bg-gray-50"
                  }`}
                onClick={() => {
                  setSelectedItem(tab);
