                  ...
                  <tr key={index} className="border-b border-gray-200 hover:bg-gray-50 text-gray-700 transition-colors">
                    ...
                    <td className="py-2 px-3">
                      <div className="flex items-center gap-1 group">
                        <Link to={`/dashboard/order/neworder/updateOrder/${row.orderId}`} className="text-[#0192ED] hover:underline block font-medium">
                          {row.orderId}
                        </Link>
                    ...
                    <td className="py-2 px-3">
                      <div className="flex items-center gap-1 group">
                        <p className="text-[#0192ED] cursor-pointer hover:underline font-medium" onClick={() => handleTrackingByAwb(row.awb_number)}>
                          {row.awb_number}
                        </p>
                    ...
                    <td className="py-2 px-3">
                      <span className={`px-2 py-0.5 rounded text-[10px] ${row.category === "debit" ? "bg-red-50 text-red-500" : "bg-blue-50 text-[#0192ED]"}`}>
                        {row.category}
                      </span>
                    </td>
                    <td className="py-2 px-3">
                      <div className="flex items-center gap-1 justify-start">
                        <span className={`${row.category === "debit" ? "text-red-500" : "text-[#0192ED]"} font-medium`}>
          ...
          <div ref={mobileActionRef} className="relative">
            ...
            {mobileDropdownOpen && (
              <div className="absolute right-0 mt-1 w-40 bg-white border-2 border-gray-200 rounded-lg shadow-xl z-[100] animate-popup-in overflow-hidden">
                <ul className="font-[600] text-[12px]">
                  <li
                    className="px-3 py-2 text-gray-700 hover:bg-blue-50 cursor-pointer"
                    onClick={() => {
                      handleExport();
                      setMobileDropdownOpen(false);
                    }}
              ...
              <div key={row.id || row._id} className="bg-white border border-gray-100 rounded-xl shadow-sm p-3 text-[11px] animate-popup-in">
                ...
                <div className="flex gap-2 justify-between items-center mb-2">
                  ...
                  <div className="text-right">
                    <span className={`px-2 py-0.5 rounded text-[10px] ${row.category === "debit" ? "bg-red-100 text-red-600" : "bg-blue-50 text-[#0192ED]"}`}>
                      {row.category}
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-y-2">
                  ...
                  <div className="text-right text-[10px]">
                    ...
                    <div className="flex items-center justify-end gap-1">
                      <p className="text-[#0192ED] font-[600] truncate hover:underline" onClick={() => handleTrackingByAwb(row.awb_number)}>
                        {row.awb_number || "N/A"}
                      </p>
                      {row.awb_number && (
                  ...
                  <div className="border-t my-1 border-gray-50 col-span-2 flex justify-between items-center">
                    <div>
                      ...
                      <div className="flex items-center gap-1">
                        <p className={`text-[10px] font-bold ${row.category === "debit" ? "text-red-500" : "text-[#0192ED]"}`}>
                          {row.category === "debit" ? "-" : "+"} ₹{Number(row.amount).toFixed(2)}
                        </p>
                        {row.category === "debit" && (
                          <button
                            ...
                            className="text-[#0192ED] p-2 -m-2 flex items-center justify-center cursor-pointer"
                          >
