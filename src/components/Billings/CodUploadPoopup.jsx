      ...
      <div className="bg-white p-4 rounded-lg shadow-lg w-[400px] relative">
        ...
        <p className="text-[10px] sm:text-[12px]">
          ...
          <button
            ...
            className="text-[#0192ED] hover:underline cursor-pointer"
          >
            click here{" "}
          </button>
        ...
        <label className="cursor-pointer flex text-[10px] sm:text-[12px] items-center gap-2 text-[#0192ED] bg-white px-3 py-2 mt-4 rounded-lg border border-[#0192ED] transition">
        ...
        <button onClick={handleSubmit} className="px-3 py-2 me-2 font-[600] hover:opacity-90 mt-2 bg-[#0192ED] text-white rounded-lg text-[10px] sm:text-[12px]">
          Submit
        </button>
