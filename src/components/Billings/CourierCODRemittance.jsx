              ...
              <tr>
                <th className="py-2 px-3">
                  <div className="flex justify-center items-center">
                    <input type="checkbox" checked={remitedData.length > 0 && selectedIds.length === remitedData.length} onChange={handleSelectAll} className="cursor-pointer accent-[#0192ED] w-3 h-3" />
                  </div>
                </th>
                  ...
                  return (
                    <tr key={index} className="border-t border-gray-200 hover:bg-blue-50/30 transition-colors">
                      ...
                      <td className="py-2 px-3 leading-tight">
                        <div className="flex items-center gap-2 group">
                          <Link to={`/dashboard/order/tracking/${row.AwbNumber}`} className="text-[#0192ED] font-bold flex items-center gap-1 hover:underline">
                            {row.AwbNumber}

                          </Link>
                          <button onClick={() => handleCopy(row.AwbNumber, row.AwbNumber + '_awb')} className="p-1 hover:bg-blue-100 rounded text-gray-400 hover:text-[#0192ED] transition-all opacity-0 group-hover:opacity-100">
                            {copiedId === row.AwbNumber + '_awb' ? <FiCheck className="text-blue-500 w-3 h-3" /> : <FiCopy className="w-3 h-3" />}
                          </button>
                        </div>
                        <div className="flex flex-col">
                  ...
                  <div className="text-right">
                    ...
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <button onClick={() => handleCopy(row.AwbNumber, row.AwbNumber + '_m_m')}>
                        {copiedId === row.AwbNumber + '_m_m' ? <FiCheck className="w-2 h-2 text-[#0192ED]" /> : <FiCopy className="w-3 h-3 text-gray-400" />}
                      </button>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-5 custom-scrollbar">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full h-9 px-3 text-[12px] font-[600] border border-gray-300 rounded-lg focus:outline-none focus:border-[#0192ED] transition-all text-gray-700 placeholder:text-gray-400"
