      ...
      <div className="rounded-lg w-full max-w-full">
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="flex items-center gap-2">
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div className="sm:w-12 sm:h-6 w-10 h-5 bg-gray-300 rounded-full peer-checked:bg-[#0192ED] relative transition duration-300">
                <div
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="sm:w-12 sm:h-6 w-10 h-5 bg-gray-300 peer-checked:bg-[#0192ED] rounded-full transition-colors"></div>
        ...
        <div className="mt-2 text-right">
          <button
            ...
            className="bg-[#0192ED] text-[10px] sm:text-[12px] font-[600] text-white px-3 py-2 rounded-lg hover:bg-blue-500 transition"
          >
            Submit
          </button>
        </div>
