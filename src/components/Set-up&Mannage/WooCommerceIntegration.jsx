...
import WooCommerce from "../../assets/woocommerceb.png"
...
const WooCommerceIntegration = () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      console.log(error)
      Notification(error?.response?.data?.message || "URL or Secret key or Client ID are not matching","error")
    }
  };
    ...
    <div className="p-2 flex flex-col justify-start">
      <div className="flex items-center sm:mb-4 mb-2">
        ...
        <h2 className="text-[12px] sm:text-[14px] font-[600] text-gray-700 flex items-center">
          ...
          />
          <span className="ml-2">WooCommerce Integration</span>
        </h2>
      </div>
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        <div className="w-full max-w-5xl bg-white shadow-lg rounded-lg p-4 sm:p-6">
          ...
          <div className="grid sm:grid-cols-2 grid-cols-1 gap-4">
            <div>
              <label className="font-[600] block text-[10px] sm:text-[12px] text-gray-500">Store Name</label>
              <input
                type="text"
                name="storeName"
            ...
            <div>
              <label className="font-[600] block text-[10px] sm:text-[12px] text-gray-500">Store URL</label>
              <input
                type="text"
                name="storeURL"
            ...
            <div>
              <label className="font-[600] block text-[10px] sm:text-[12px] text-gray-500">Store Client ID</label>
              <input
                type="text"
                name="storeClientId"
            ...
            <div>
              <label className="font-[600] block text-[10px] sm:text-[12px] text-gray-500">Store Client Secret</label>
              <input
                type="text"
            ...
            <div>
              <label className="font-[600] block text-[10px] sm:text-[12px] text-gray-500">Order Sync Frequency</label>
               <CustomDropdown
          ...
          <div className="mt-4 w-full">
            ...
            <div className="flex gap-4 justify-between">
              ...
              <label className="font-[600] block text-[10px] sm:text-[12px] text-gray-500">COD</label>
              <CustomDropdown
            ...
            <div className="mt-2 w-full">
              <label className="font-[600] block text-[10px] sm:text-[12px] text-gray-500">Prepaid</label>
              <CustomDropdown
          ...
          <div className="mt-4">
            ...
            <div className="mt-2">
              <label className="font-[600] block text-[10px] sm:text-[12px] text-gray-500">Sync From Date</label>
              <input
                type="date"
                name="syncDate"
          ...
          <p className="text-left text-[10px] mt-2 text-gray-700">Please click on the "Add Channel" button, to integrate with your WooCommerce account.</p>
        </div>

        {/* Instructions Section */}
        <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-4 sm:p-6">
          <h3 className="text-[10px] sm:text-[14px] font-[600] text-gray-700">Steps to Integrate WooCommerce</h3>
          <ul className="list-decimal list-inside mt-2 text-gray-700 space-y-2 font-[400] text-[10px] sm:text-[12px]">
            <li>Fill in your WooCommerce credentials and API details.</li>
            <li>If you don't have API details, go to WooCommerce settings and generate a key.</li>
            <li>Enable REST API access and set permissions to "read/write".</li>
            <li>Copy and paste the generated API key and secret into the form above.</li>
            <li>Click "Add Channel" to complete the integration.</li>
          </ul>
        </div>
      </div>
    </div>
