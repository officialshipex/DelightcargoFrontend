                ...
                <div className="flex space-x-2">
                    ...
                    <div className="flex-1 relative" ref={courierRef}>
                        ...
                        <button
                            ...
                            className="w-full border text-[10px] sm:text-[12px] font-[600] border-gray-300 rounded-lg px-3 py-2 text-left focus:outline-none focus:ring-1 focus:ring-[#0192ED] focus:border-[#0192ED] transition-all"
                        >
                                ...
                                {couriers.length === 0 ? (
                                    ...
                                    couriers.map(courier => (
                                        <li
                                            ...
                                            className="cursor-pointer px-3 py-2 text-[10px] sm:text-[12px] font-[600] text-gray-500 hover:bg-blue-50"
                                        >
                    ...
                    <div className="flex-1 relative" ref={serviceRef}>
                        ...
                        <button
                            ...
                            className={`w-full border border-gray-300 text-gray-700 text-[10px] sm:text-[12px] font-[600] rounded-lg px-3 py-2 text-left focus:outline-none focus:ring-1 focus:ring-[#0192ED] focus:border-[#0192ED] transition-all ${!form.courier ? 'opacity-50 cursor-not-allowed' : ''
                                }`}
