      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-4 w-full max-w-lg relative space-y-4">
        ...
        <div className="flex space-x-2">
          ...
          <div className="flex-1 min-w-0 relative" ref={courierRef}>
            ...
            <button
              ...
              className="w-full border text-[10px] sm:text-[12px] font-[600] text-gray-500 border-gray-300 rounded-lg px-3 py-2 text-left focus:outline-none focus:ring-1 focus:ring-[#0192ED] focus:border-[#0192ED] transition-all overflow-hidden text-ellipsis whitespace-nowrap"
            >
          ...
          <div className="flex-1 min-w-0 relative" ref={serviceRef}>
            ...
            <button
              ...
              className={`w-full border border-gray-300 text-gray-700 text-[10px] sm:text-[12px] font-[600] rounded-lg px-3 py-2 text-left focus:outline-none focus:ring-1 focus:ring-[#0192ED] focus:border-[#0192ED] transition-all overflow-hidden text-ellipsis whitespace-nowrap ${form.couriers.length === 0 ? 'opacity-50 cursor-not-allowed' : ''}`}
          ...
          {['zoneA', 'zoneB', 'zoneC', 'zoneD', 'zoneE'].map((zone) => (
            <div key={zone} className="w-1/5 px-2">
              ...
              <input
                ...
                min="0"
                step="any"
                className="block w-full px-2 py-1 text-gray-700 rounded-lg border text-[10px] sm:text-[12px] border-gray-300 shadow-sm focus:ring-1 focus:ring-[#0192ED] focus:border-[#0192ED] transition-all outline-none"
              />
            </div>
          ))}
        </div>
        ...
        <div className="flex justify-end space-x-2">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`px-3 py-2 text-[10px] sm:text-[12px] font-[600] rounded-lg text-white ${loading ? 'bg-blue-300 cursor-not-allowed' : 'bg-[#0192ED] hover:opacity-90'
              } transition`}
          >
            {loading ? 'Saving...' : 'Save'}
          </button>
