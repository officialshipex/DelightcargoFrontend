      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        ...
        <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-4 sm:p-6">
          ...
          <ul className="list-decimal list-inside mt-2 text-gray-700 space-y-2 font-[400] text-[10px] sm:text-[12px]">
            <li>Fill in your Shopify Store name, Store URL, Store Client ID and Store client secret. Enter the details and click on add Channel to connect Shopify with DelightCargo.</li>
            <li>
