    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 animate-popup-in flex justify-center items-center z-[70] p-4">
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-6 w-full max-w-lg relative space-y-4">
        <div className="flex items-center gap-2 mb-2">
          <Clock className="w-5 h-5 text-[#0192ED]" />
        ...
        <div className="flex space-x-4">
          ...
          <div className="flex-1 relative" ref={courierRef}>
            ...
            <button
              ...
              className="w-full border text-[12px] font-[600] text-gray-700 border-gray-300 rounded-lg px-3 py-2 text-left focus:outline-none focus:ring-1 focus:ring-[#0192ED] focus:border-[#0192ED] transition-all bg-white shadow-sm"
            >
                ...
                {couriers.length === 0 ? (
                  ...
                  couriers.map((courier) => (
                    <li
                      ...
                      className="cursor-pointer px-3 py-2 text-[12px] font-[600] text-gray-600 hover:bg-blue-50"
                    >
          ...
          <div className="flex-1 relative" ref={serviceRef}>
            ...
            <button
              ...
              className={`w-full border border-gray-300 text-gray-700 text-[12px] font-[600] rounded-lg px-3 py-2 text-left focus:outline-none focus:ring-1 focus:ring-[#0192ED] focus:border-[#0192ED] transition-all bg-white shadow-sm ${!form.courier ? 'opacity-50 cursor-not-allowed' : ''
                }`}
        ...
        <div className="space-y-1">
          ...
          <input
            type="time"
            required
            className="w-full h-10 px-3 py-2 text-[12px] border rounded-lg border-gray-300 focus:outline-none focus:ring-1 focus:ring-[#0192ED] focus:border-[#0192ED] bg-white transition-all shadow-sm"
        ...
        <div className="flex justify-end space-x-3 pt-4 border-t">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`px-6 py-2 text-[12px] font-[600] rounded-lg text-white shadow-md ${loading ? 'bg-blue-300 cursor-not-allowed' : 'bg-[#0192ED] hover:opacity-90'
              } transition`}
          >
