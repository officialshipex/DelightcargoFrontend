    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 animate-popup-in flex justify-center items-center z-[70] p-4">
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-4 w-full max-w-lg relative space-y-4">
        <div className="flex items-center gap-2 mb-1">
          <Clock className="w-4 h-4 text-[#0192ED]" />
        ...
        <div className="flex space-x-2">
          ...
          <div className="flex-1 min-w-0 relative" ref={courierRef}>
            ...
            <button
              ...
              className="w-full border text-[10px] sm:text-[12px] font-[600] text-gray-700 border-gray-300 rounded-lg px-3 py-2 text-left focus:outline-none focus:ring-[#0192ED] focus:border-[#0192ED] transition-all bg-white shadow-sm overflow-hidden text-ellipsis whitespace-nowrap"
            >
                ...
                {couriers.length === 0 ? (
                  ...
                  couriers.map((courier) => (
                    <div
                      ...
                      className="cursor-pointer px-3 py-2 text-[10px] sm:text-[12px] font-[600] text-gray-500 hover:bg-blue-50 flex items-center gap-2"
                    >
                      <input 
                        type="checkbox" 
          ...
          <div className="flex-1 min-w-0 relative" ref={serviceRef}>
            ...
            <button
              ...
              className={`w-full border border-gray-300 text-gray-700 text-[10px] sm:text-[12px] font-[600] rounded-lg px-3 py-2 text-left focus:outline-none focus:ring-[#0192ED] focus:border-[#0192ED] transition-all bg-white shadow-sm overflow-hidden text-ellipsis whitespace-nowrap ${form.couriers.length === 0 ? 'opacity-50 cursor-not-allowed' : ''}`}
        ...
        <div className="space-y-1">
          <div className="flex justify-between items-center mb-1">
            ...
            <span className="text-[10px] sm:text-[12px] font-[700] text-[#0192ED] bg-blue-50 px-2 py-0.5 rounded border border-blue-100 italic">
          ...
          <input
            type="time"
            required
            className="w-full h-10 px-3 py-2 text-[10px] sm:text-[12px] border rounded-lg border-gray-300 focus:outline-none focus:ring-[#0192ED] focus:border-[#0192ED] bg-white transition-all shadow-sm"
        ...
        <div className="flex justify-end space-x-2 pt-4 border-t">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`px-3 py-2 text-[10px] sm:text-[12px] font-[600] rounded-lg text-white shadow-md ${loading ? 'bg-blue-300 cursor-not-allowed' : 'bg-[#0192ED] hover:opacity-90'
              } transition`}
          >
            {loading ? 'Saving...' : 'Save'}
          </button>
