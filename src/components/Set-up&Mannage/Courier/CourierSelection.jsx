                  ...
                  <td className="py-2 px-3">
                    <div className="flex justify-center">
                      <label className="relative inline-flex items-center cursor-pointer">
                        ...
                        />
                        <div className="w-10 h-5 bg-gray-300 rounded-full peer-checked:bg-[#0192ED] relative transition-all duration-300">
                          <div
            ...
            >
              ...
              <div className="flex items-center justify-between mt-3 px-1">
                <div className="text-[11px] text-gray-500">
                  Status: <span className={courier.status === "Active" ? "text-[#0192ED] font-[600]" : "text-red-500 font-[600]"}>{courier.status}</span>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
