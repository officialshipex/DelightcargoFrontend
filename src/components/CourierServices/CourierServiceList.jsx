      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md overflow-visible transform transition-all animate-popup-in border border-gray-100 relative">
        ...
        <div className="p-4 border-b border-gray-100">
          <h2 className="text-[14px] font-bold text-gray-700 flex items-center gap-2">
            <div className="bg-blue-100 p-2 rounded-lg text-[#0192ED]">
              <FaTruck size={18} />
            </div>
            Change Provider
          </h2>
        ...
        <div className="p-6 space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="bg-gray-50 border border-gray-200 px-3 py-2 rounded-lg text-[12px] font-semibold text-[#0192ED]">
              {firstProvider}
            </div>
          </div>
        ...
        <div className="p-4 bg-gray-50 flex justify-end gap-3">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-[12px] font-bold text-white transition-all 
              ${(!targetProvider || loading) ? "bg-gray-300 cursor-not-allowed" : "bg-[#0192ED] hover:bg-[#0aa66e] active:scale-95 shadow-sm"}`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-lg text-[11px] font-bold transition-all shadow-sm border
              ${selectedIds.length === 0 
                ...
                : "bg-[#0192ED] text-white border-[#0192ED] hover:bg-blue-600 active:scale-95"}`}
          >
            <span>Actions</span>
          ...
          {isActionMenuOpen && selectedIds.length > 0 && (
            <div className="absolute top-full right-0 mt-1 w-48 bg-white border border-gray-200 rounded-xl shadow-xl z-[100] py-1 animate-popup-in">
              <button
                ...
                className="w-full text-left px-4 py-2 text-[11px] font-bold text-gray-600 hover:bg-[#0192ED]/10 hover:text-[#0192ED] flex items-center gap-2"
              >
                <div className="w-6 h-6 rounded-lg bg-[#0192ED]/10 flex items-center justify-center">
                  <FaTruck size={12} />
                </div>
                Change Provider
              </button>
            ...
            <thead className="sticky top-0 z-10">
              <tr className="text-white bg-[#0192ED] font-[600] text-[12px]">
                <th className="py-2 px-3 text-center">
                  <input
                    type="checkbox"
                    className="rounded border-white/30 bg-white/20 checked:bg-white text-[#0192ED] accent-[#0192ED] focus:ring-0 cursor-pointer w-3 h-3"
                ...
                filteredCouriers.map((courier, index) => (
                  <tr key={courier._id} className="border-b border-gray-300 text-gray-500 hover:bg-gray-50 transition-all text-[12px]">
                    <td className="py-2 px-3 text-center">
                      <input
                        type="checkbox"
                        className="rounded border-gray-300 text-[#0192ED] accent-[#0192ED] focus:ring-[#0192ED]/20 cursor-pointer w-3 h-3"
                    ...
                    <td className="py-2 px-3">
                      <span className="text-[#0192ED] font-[700] bg-[#0192ED]/5 px-2 py-0.5 rounded-md border border-[#0192ED]/10">
                        {courier.provider}
                      </span>
                    </td>
                    ...
                    <td className="py-2 px-3">
                      <div className="flex items-center gap-2">
                        <button
                          className={`p-1.5 rounded-lg text-[#0192ED] bg-[#0192ED]/5 hover:bg-[#0192ED]/20 transition-all ${canUpdate ? "active:scale-90" : "opacity-50 cursor-not-allowed"}`}
