      ...
      <div className="sm:px-2 flex flex-col h-full overflow-hidden bg-gray-50/30">
        ...
        <div className="flex flex-col sm:flex-row w-full gap-2 mb-2 items-end">
          <div className="flex flex-col sm:flex-row flex-1 gap-2 w-full">
            ...
            <div className="grid grid-cols-2 sm:flex sm:flex-row gap-2 w-full sm:w-auto">
                ...
                {isPlanOpen && (
                  <div className="absolute font-[600] top-full left-0 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-sm z-[100] animate-in fade-in slide-in-from-top-2 max-h-48 overflow-y-auto">
                    <div
                      ...
                      className="px-3 py-2 text-[10px] hover:bg-[#0192ED]/10 hover:text-[#0192ED] cursor-pointer transition-colors"
                    >
                      All Plans
                    </div>
              ...
              <div className="relative w-full sm:min-w-[120px] font-[600] sm:order-last">
                <div
                  ...
                  className="flex items-center justify-between border border-gray-300 bg-white px-3 py-1.5 h-9 rounded-lg cursor-pointer hover:border-[#0192ED] transition-all group"
                >
                ...
                {isStatusOpen && (
                  <div className="absolute top-full left-0 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl z-[100] animate-in fade-in slide-in-from-top-2">
                    <div onClick={() => { setStatusFilter(""); setIsStatusOpen(false); }} className="px-3 py-2 text-[10px] hover:bg-[#0192ED]/10 hover:text-[#0192ED] cursor-pointer transition-colors">All Status</div>
                    <div onClick={() => { setStatusFilter("Active"); setIsStatusOpen(false); }} className="px-3 py-2 text-[10px] hover:bg-[#0192ED]/10 hover:text-[#0192ED] cursor-pointer transition-colors">Active</div>
                    <div onClick={() => { setStatusFilter("Inactive"); setIsStatusOpen(false); }} className="px-3 py-2 text-[10px] hover:bg-[#0192ED]/10 hover:text-[#0192ED] cursor-pointer transition-colors">Inactive</div>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="relative font-[600] w-full sm:w-[220px]">
              ...
              <input
                ...
                className="w-full border border-gray-300 pl-9 pr-3 py-1.5 h-9 rounded-lg text-[10px] sm:text-[12px] bg-white focus:border-[#0192ED] focus:ring-1 focus:ring-[#0192ED]/20 outline-none transition-all placeholder:text-gray-400"
              />
            </div>
          </div>
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            <button
              className={`bg-[#0192ED] sm:text-[12px] text-[10px] font-bold hover:bg-opacity-90 text-white px-3 h-9 rounded-lg transition-all ${canAction ? "" : "opacity-50 cursor-not-allowed"}`}
                    ...
                    <tr className="border-b border-gray-100 text-center text-gray-700 text-[12px] transition-colors">
                      ...
                      <td rowSpan={2} className="px-3 py-2">
                        <div className="flex justify-center items-center gap-1.5">
                          <button
                            className={`text-[#0192ED] transition-all ${canUpdate ? "" : "opacity-30 cursor-not-allowed"}`}
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button onClick={() => canUpdate && navigate(`/dashboard/ratecard/update/${card._id}`)} className="text-[#0192ED] transition-transform active:scale-90"><FaEdit size={12} /></button>
                ...
                <div className="grid grid-cols-2 gap-2 pb-2 border-b border-gray-50 bg-gray-50/50 p-2 rounded-lg">
                  ...
                  <div className="text-right">
                    ...
                    <span className="text-[#0192ED] font-bold text-[10px]">₹{card.weightPriceBasic[0]?.zoneA || "-"}</span>
                  </div>
                </div>
