            ...
            <div className="bg-white rounded-lg shadow-md p-5 w-80 relative">
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                    <input
                        ...
                        className="w-full border border-gray-300 text-[11px] sm:text-[12px] font-medium placeholder:text-gray-400 text-gray-700 focus:border-[#0192ED] focus:outline-none px-3 py-2 rounded-lg transition-all"
                        required
                    ...
                    <div className="flex justify-end gap-2">
                        ...
                        <button
                            type="submit"
                            className={`bg-[#0192ED] text-white px-3 py-2 rounded-lg text-[10px] sm:text-[12px] font-[600] ${!planName.trim() ? "opacity-50 cursor-not-allowed" : "hover:bg-blue-500"} transition-all duration-300`}
