            ...
            <div className="bg-white p-4 rounded-lg shadow-sm w-[500px] relative animate-popup-in border border-gray-100">
                ...
                <div className="space-y-2">
                    <label className="group cursor-pointer block relative">
                        ...
                        `}>
                            <div className={`p-4 rounded-full mb-3 transition-colors ${selectedFile ? 'bg-[#0192ED] text-white' : 'bg-gray-100 text-gray-400 group-hover:bg-blue-50 group-hover:text-[#0192ED]'}`}>
                                <FaUpload size={16} />
                            </div>
                ...
                <div className="flex justify-end items-center mt-8 gap-3">
                    <button
                        ...
                        className="py-2 px-3 bg-[#0192ED] text-white rounded-lg text-[10px] sm:text-[12px] font-bold hover:opacity-90 transition-all flex items-center justify-center gap-2"
                    >
                        Confirm & Upload
                    </button>
                </div>
