    ...
    <div className="max-w-5xl mx-auto p-4 sm:bg-white sm:shadow-sm sm:rounded-lg bg-white min-h-[calc(100vh-320px)]">
      <div className="flex items-center gap-3 border-b border-gray-100 pb-4 mb-4">
        ...
        <h2 className="text-[12px] sm:text-[14px] font-bold text-gray-700">
          Rate Cards <span className="text-gray-400 font-medium mx-1">|</span> <span className="text-[#0192ED]">Form</span>
        </h2>
      </div>
        ...
        <div className="flex gap-2 w-full sm:w-auto flex-1">
          ...
          {!userId && (
            <div className="relative flex-1 sm:max-w-[180px]">
              ...
              >
                ...
                <FiChevronDown className={`text-gray-400 group-hover:text-[#0192ED] transition-transform flex-shrink-0 ${isPlanOpen ? "rotate-180" : ""}`} />
              </div>
              {isPlanOpen && (
          ...
          <div className="relative flex-1 sm:w-[200px] sm:max-w-[200px]">
            ...
            >
              ...
              <FiChevronDown className={`text-gray-400 group-hover:text-[#0192ED] transition-transform flex-shrink-0 ${isProviderOpen ? "rotate-180" : ""}`} />
            </div>
            {isProviderOpen && (
              <div className="absolute font-[600] top-full left-0 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-sm z-[100] animate-in fade-in slide-in-from-top-2 max-h-48 overflow-y-auto">
                {couriers &&
        ...
        <div className="flex gap-2 w-full">
          ...
          <div className="relative min-w-[100px] flex-1 sm:max-w-[120px]">
            ...
            >
              ...
              <FiChevronDown className={`text-gray-400 group-hover:text-[#0192ED] transition-transform flex-shrink-0 ${isStatusOpen ? "rotate-180" : ""}`} />
            </div>
            {isStatusOpen && (
          ...
          <div className="relative min-w-[100px] flex-1 sm:max-w-[120px]">
            ...
            >
              ...
              <FiChevronDown className={`text-gray-400 group-hover:text-[#0192ED] transition-transform flex-shrink-0 ${isShipmentTypeOpen ? "rotate-180" : ""}`} />
            </div>
            {isShipmentTypeOpen && (
              <div className="absolute font-[600] top-full left-0 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-sm z-[100] animate-in fade-in slide-in-from-top-2">
      ...
      <div className="flex items-center gap-4 mt-6 mb-4 p-3 bg-gray-50 rounded-lg border border-gray-100">
        <label className="flex items-center gap-2 cursor-pointer group">
          <div className="relative">
            ...
            />
            <div className="w-10 h-5 bg-gray-200 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-[#0192ED]"></div>
          </div>
          <span className="text-[12px] font-bold text-gray-700 group-hover:text-[#0192ED] transition-colors">Is Flat Rate?</span>
        </label>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="md:col-span-2">
          <h2 className="text-[#0192ED] font-bold text-[14px] mb-4 border-b border-[#0192ED]/20 pb-2">Forward Charges</h2>
          ...
          {formData.weightPriceBasic.map((item, index) => (
            <div key={index} className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 mt-2">
              <input
                ...
                value={item.weight}
                className="border border-gray-300 h-9 text-gray-700 font-[600] px-3 rounded-lg text-[10px] sm:text-[12px] w-full focus:border-[#0192ED] focus:outline-none transition-all"
              ...
              {["A", "B", "C", "D", "E"].map((zone) => (
                <input
                  ...
                  className="border border-gray-300 text-gray-700 font-[600] px-3 h-9 rounded-lg text-[10px] sm:text-[12px] w-full focus:border-[#0192ED] focus:outline-none transition-all"
      ...
      <div className="flex gap-2">
        <input
          ...
          className="border border-gray-300 h-9 text-gray-700 font-[600] mt-2 px-3 rounded-lg text-[10px] sm:text-[12px] w-full sm:w-auto focus:border-[#0192ED] focus:outline-none transition-all"
      ...
      <div className="mt-4 flex justify-center gap-2 border-t border-gray-100 pt-6">
        ...
        <button
          className="bg-[#0192ED] text-white hover:bg-opacity-90 px-3 py-2 rounded-lg text-[10px] sm:text-[12px] font-bold transition-all"
          onClick={handleSave}
        >
          Save Rate Card
        </button>
