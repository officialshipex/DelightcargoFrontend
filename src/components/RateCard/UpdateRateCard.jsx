    ...
    <div className="max-w-5xl mx-auto p-4 sm:bg-white sm:shadow-sm sm:rounded-lg bg-white min-h-[calc(100vh-320px)]">
      <div className="flex items-center gap-3 border-b border-gray-100 pb-4 mb-4">
        ...
        <h2 className="text-[12px] sm:text-[14px] font-bold text-gray-700">
          Rate Cards <span className="text-gray-400 font-medium mx-1">|</span> <span className="text-[#0192ED]">Update</span>
        </h2>
      </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 mt-2">
            {["weight", "zoneA", "zoneB", "zoneC", "zoneD", "zoneE"].map((field) => (
              <input
                ...
                className="border border-gray-300 h-9 font-[600] text-gray-700 px-3 rounded-lg text-[10px] sm:text-[12px] w-full focus:border-[#0192ED] focus:outline-none transition-all"
      ...
      <div className="flex gap-2">
        <input
          ...
          className="border border-gray-300 h-9 font-[600] text-gray-700 mt-2 px-3 rounded-lg text-[10px] sm:text-[12px] w-full sm:w-auto focus:border-[#0192ED] focus:outline-none transition-all"
