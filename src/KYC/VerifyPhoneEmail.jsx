...
const VerifyPhoneEmail = ({ onVerificationChange }) => {
    ...
    return (
        ...
        focus:ring-1 focus:ring-[#0192ED] focus:border-[#0192ED]"
                    />
                </div>

                {phoneVerified ? (
                    <div className="flex items-center gap-1 text-[#0192ED] font-semibold w-[100px] text-[12px] mt-5 sm:mb-2">
                    ...
                    <button
                        ...
                        className={`text-[10px] font-[600] border-2 border-[#0192ED] px-3 w-[100px] h-9 mt-[21px] py-2 rounded-lg transition-all duration-200 ${phoneOtpTimer > 0 || loadingPhoneOtp
                            ? "bg-gray-200 text-gray-500 cursor-not-allowed"
                            : "bg-[#0192ED] text-white hover:bg-[#0aa56c]"
                            }`}
                    >
                        {loadingPhoneOtp
                            ? "Sending..."
        ...
        focus:ring-1 focus:ring-[#0192ED] focus:border-[#0192ED]"
                ...
                {emailVerified ? (
                    <div className="flex items-center gap-1 w-[100px] text-[#0192ED] font-semibold text-[12px] mt-5 sm:mb-2">
                        <CheckCircleIcon className="w-6 h-6" />
                        Verified
                    </div>
                ) : (
                    <button
                        ...
                        className={`text-[10px] font-[600] border-2 border-[#0192ED] w-[100px] h-9 mt-[21px] px-3 py-2 rounded-lg transition-all duration-200 ${emailOtpTimer > 0 || loadingEmailOtp
                            ? "bg-gray-200 text-gray-500 cursor-not-allowed"
                            : "bg-[#0192ED] text-white hover:bg-[#0aa56c]"
                            }`}
                    >
