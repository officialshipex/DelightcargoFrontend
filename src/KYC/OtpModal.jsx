...
const OtpModal = ({
    ...
    return (
        <>
          ...
          space-y-3 animate-fadeIn"
            ...
            >
                ...
                {/* Label */}
                <div className="text-[#0192ED] text-base font-bold mb-2">{label}</div>
        ...
        focus:ring-2 focus:ring-[#0192ED] transition-all ${errorShake ? "animate-shake border-red-500" : ""
                                }`}
                        />
                    ))}
                </div>
                ...
                <div className="flex flex-col items-center w-full">
                    {timer > 0 ? (
                        ...
                        <button
                            type="button"
                            className="text-[#0192ED] underline text-xs mt-1"
                            onClick={onResend}
                            disabled={loading}
                        >
