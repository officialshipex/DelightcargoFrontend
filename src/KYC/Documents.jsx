            ...
            <div>
                ...
                <form className="space-y-7 px-6 sm:px-0">
                    ...
                    <div>
                        ...
                        <select
                            className="mt-1 block w-full text-sm p-1 border border-gray-300 rounded-lg focus:outline-none focus:ring-[#0192ED] focus:border-[#0192ED] bg-white"
                    ...
                    <div className="flex flex-wrap space-y-4 sm:space-x-4 sm:space-y-0">
                        ...
                        <div className="flex items-center min-w-[120px]">
                            <button
                                type="button"
                                className={`w-full h-9 sm:w-40 md:mt-5 px-2 py-1 text-sm text-white bg-[#0192ED] hover:bg-[#0192ED] rounded-lg`}
                                onClick={verifyPAN}
                                disabled={loadingState.panVerifying || verificationState.isPanVerified}
                            >
                    ...
                    <div className="flex flex-wrap space-y-4 sm:space-x-4 sm:space-y-0">
                        <div className="flex-1 min-w-[200px]">
                            ...
                            <input
                                type="text"
                                id="aadhaarNumber"
                                className="mt-1 md:w-1/2 block w-full text-sm p-1 border border-gray-300 rounded-lg focus:outline-none focus:ring-[#0192ED] focus:border-[#0192ED] bg-gray-200"
                    ...
                    <div className="flex flex-col sm:flex-row justify-between space-y-4 sm:space-y-0 sm:space-x-4">
                        ...
                        <button
                            type="submit"
                            className="px-6 py-2 text-white bg-[#0192ED] hover:bg-[#0192ED] rounded-lg shadow-sm transition focus:outline-none focus:ring-[#0192ED] focus:border-[#0192ED] w-full sm:w-auto"
                            onClick={handleNext}
                        >
                            Save & Next →
                        </button>
