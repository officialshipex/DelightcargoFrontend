...
const BusinessTypeSelection = () => {
  ...
  return (
        ...
        {steps.map((step, index) => (
          ...
          >
            ...
            ${index === currentStep
                    ...
                    : index < currentStep
                      ? "bg-[#0192ED] border-[#0192ED] text-white"
          ...
          `}
              ...
              {index !== steps.length - 1 && (
                <div className="hidden sm:block absolute left-[150px] top-1/2 transform -translate-y-1/2 w-24 h-0.5 bg-[#0192ED]"></div>
              )}

              {/* Line for mobile (circle to circle only) */}
              {index !== steps.length - 1 && (
                <div className="sm:hidden absolute top-full left-4 transform -translate-x-1/2 w-0.5 h-6 bg-[#0192ED]"></div>
              )}
            ...
            ${index === currentStep ? "text-[#0192ED]" : "text-gray-500"}
          `}
              >
                {step}
              </span>
            ...
            <div className="w-full">
                  ...
                  {[
                    ...
                    <label
                      ...
                      className={`flex items-center gap-3 border-2 rounded-lg px-4 py-2 w-full sm:w-60 cursor-pointer transition duration-150 ${selectedType === option.value
                        ? "border-[#0192ED] bg-blue-50"
                        : "border-gray-300 hover:border-[#0192ED]"
                        }`}
                    ...
                    >
                      <input
                        ...
                        className="accent-[#0192ED] cursor-pointer outline-none ring-0 appearance-none w-3 h-3 border-2 border-gray-300 checked:border-[#0192ED] checked:bg-[#0192ED] rounded-full"
                      />

                      <div className="flex items-center gap-2 text-gray-700 font-[600] sm:text-[14px] text-[12px]">
                        <span className="text-[#0192ED]">{option.icon}</span>
                        {option.label}
                      </div>
                    </label>
                  ))}
              ...
              {(selectedType === "individual" && !isGstinVerified) && (
                <div className="lg:w-full max-w-full bg-white p-4 sm:p-6 rounded-lg shadow-md">
                  <h2 className="sm:text-[14px] text-[12px] text-[#0192ED] font-[600] sm:mb-2">Billing Information</h2>
                  <div className="grid grid-cols-2 md:grid-cols-6 sm:gap-2 gap-2 sm:px-4 md:px-0 items-end">
                    ...
                    <div className="flex flex-col col-span-2 gap-1">
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 text-[12px] border border-gray-300 rounded-lg outline-none focus:ring-1 focus:ring-[#0192ED] text-gray-500 ${isBillingVerified ? "cursor-not-allowed" : ""
                          }`}
                      />
    ...
    focus:ring-1 focus:ring-[#0192ED] text-gray-500 
    ${isBillingVerified ? "cursor-not-allowed" : ""}`}
                    ...
                    <div className="flex justify-start">
                      {isBillingVerified ? (
                        <div className="flex items-center gap-2 mb-1.5 text-[#0192ED]">
                          <CheckCircleIcon />
                        ...
                        <button
                          ...
                          disabled={isBillingVerified}
                          className="text-white mb-0.5 sm:text-[12px] text-[10px] py-2 px-3 rounded-lg bg-[#0192ED] hover:bg-[#0aa66c] transition-all duration-200"
                        >
                          Submit
                        </button>
                      )}
                  ...
                  <div className="flex flex-col items-center w-full">
                    <div className="w-full">
                      <div className="bg-white sm:p-6 p-3 rounded-lg max-w-full shadow-md relative">
                        ...
                        <h3 className="sm:text-[14px] text-[12px] text-[#0192ED] font-[600] sm:mb-3 mb-2">
                          GSTIN Verification
                        </h3>
      ...
      focus:ring-2 focus:ring-[#0192ED] focus:border-[#0192ED]"
                              value={gstNumber}
                          ...
                          <div className="flex flex-col justify-end w-auto">
                            {isGstinVerified ? (
                              <div className="flex items-center gap-1 mb-2 text-[#0192ED] font-semibold text-[12px]">
                              ...
                              <button
                                ...
                                disabled={isGstinVerified}
                                className="bg-[#0192ED] text-white text-[12px] px-3 py-2 rounded-lg 
            ...
            <div className="w-full max-w-full rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mb-4 w-full">
                <div className="p-6 rounded-lg shadow-md bg-white w-full">
                  <h3 className="font-[600] text-[#0192ED] text-[14px] mb-2">Aadhaar Verification</h3>
                  ...
                  <div className="grid sm:grid-cols-5 grid-cols-2 gap-2 w-full items-end">
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 text-gray-500 text-[12px] font-[600] border border-gray-300 rounded-lg outline-none focus:ring-1 focus:ring-[#0192ED]"
                    ...
                    <div className="flex items-end">
                      {!isAadharVerified ? (
                        <button
                          ...
                          className="bg-[#0192ED] text-white px-3 py-2 text-[12px] rounded-lg w-auto"
                          disabled={isAadharVerified || isLoading || timerActive}
                        >
                          {isOtpSent ? "OTP Sent" : "Send OTP"}
                        </button>
                      ) : (
                        <div className="flex items-center gap-1 mb-1.5 text-[#0192ED] font-semibold text-[12px]">
                ...
                {isOtpPopupOpen && (
                  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-80 relative">
                      ...
                      <h2 className="text-[14px] font-[600] mb-3 text-[#0192ED] text-center">Verify Aadhaar OTP</h2>
      ...
      focus:border-[#0192ED] focus:ring-1 focus:ring-[#0192ED] outline-none"
                            autoFocus={idx === 0}
                          />
                        ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mb-4">
                <div className="p-6 rounded-lg shadow-md bg-white">
                  <h3 className="font-[600] text-[#0192ED] text-[14px] mb-2">PAN Verification</h3>
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-2 items-end">
                    ...
                    <div className="flex flex-row md:flex-row gap-2 col-span-1">
                      ...
                      <div className="flex items-center gap-2">
                        {isPanVerified ? (
                          <>
                            <CheckCircleIcon className="text-[#0192ED] mt-5" />
                            <span className="text-[#0192ED] font-semibold mt-5 text-[12px]">Verified</span>
                          </>
                        ) : (
                          <button
                            onClick={() => handleVerify("pan")}
                            className="px-3 py-2 text-[12px] mt-6 rounded-lg text-white bg-[#0192ED] hover:bg-[#0aa66c]"
              ...
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mb-4">
                <div className="p-6 rounded-lg shadow-md bg-white">
                  <h3 className="font-[600] text-[#0192ED] text-[14px] mb-2">Bank Details</h3>
                  <div className="grid grid-cols-2 md:grid-cols-6 gap-x-2 gap-y-2 mt-2 items-end">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex gap-2 items-center">
                        ...
                        />
                        {isBankVerified ? (
                          <div className="flex items-center gap-1 text-[#0192ED] font-semibold text-[12px]">
                            <CheckCircleIcon />
                            <span>Verified</span>
                          </div>
                        ) : (
                          <button
                            ...
                            className="text-white text-[12px] px-3 py-2 rounded-lg bg-[#0192ED] hover:bg-[#0aa66c]"
                            disabled={false}
                          >
                            Verify
                          </button>
              ...
              <div className="flex items-start gap-2 mb-4">
                <input
                  type="checkbox"
                  id="agree"
                  className="h-4 w-4 accent-[#0192ED] border-[#0192ED] rounded focus:ring-[#0192ED]"
                  checked={checked}
                  onChange={handleChecked}
                />
                <label htmlFor="agree" className="text-[12px] text-gray-600 font-normal leading-snug">
                  By submitting this form, you agree to DelightCargo&apos;s User Privacy Statement. <span
                    className="text-[#0192ED] underline font-[600] cursor-pointer text-[12px]"
    ...
    ${(currentStep === 0 && (!(isBillingVerified || isGstinVerified) || !isPhoneVerified || !isEmailVerified)) ||
                  ...
                  : "bg-[#0192ED] hover:bg-[#09946A] text-white"
                }`}
            >
