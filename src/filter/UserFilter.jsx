        ...
        <div className="z-50">
            <div className="w-full relative ml-auto">
                <input
                    ...
                    className="w-full h-9 py-2 px-3 text-[12px] font-[600] border border-gray-300 rounded-lg placeholder:text-gray-400 placeholder:font-[600] focus:outline-none focus:border-[#0192ED] transition-colors"
                    onChange={(e) => {
