                    ...
                    <div className="space-y-1" ref={categoryRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} ${showCategoryDropdown ? "border-[#0192ED]" : "border-gray-300"} bg-white`}
                            >
                    ...
                    <div className="space-y-1" ref={descriptionRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} ${showDescriptionDropdown ? "border-[#0192ED]" : "border-gray-300"} bg-white`}
                            >
