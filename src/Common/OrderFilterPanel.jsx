        ...
        <div className="fixed inset-0 z-[100] flex justify-end">
            ...
            <div className="relative w-full max-w-[340px] bg-white h-full shadow-2xl flex flex-col animate-slide-in-right">
                    ...
                    <div className="space-y-1 relative" ref={searchRef}>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`${fieldStyle} bg-white border text-gray-700 placeholder:text-gray-400 focus:outline-none focus:border-[#0192ED]`}
                            ...
                            {loadingSuggestions && (
                                <div className="absolute right-3 top-1/2 -translate-y-1/2">
                                    <Loader2 className="w-4 h-4 text-[#0192ED] animate-spin" />
                                </div>
                            )}
                        </div>
                            ...
                            <div className="absolute top-[105%] left-0 w-full bg-white border border-gray-100 rounded-lg shadow-xl z-[110] py-1 animate-popup-in max-h-60 overflow-y-auto">
                                {suggestions.map((receiver, idx) => (
                                    <div
                                        ...
                                        className="px-3 py-2 border-b border-gray-50 last:border-0 hover:bg-blue-50 cursor-pointer transition-colors"
                                    >
                    ...
                    <div className="space-y-1" ref={paymentRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} ${showPaymentDropdown ? "border-[#0192ED]" : "border-gray-200"} bg-white`}
                            >
                                ...
                                <div className="absolute top-[105%] left-0 w-full bg-white border border-gray-100 rounded-lg shadow-xl z-10 py-1 animate-popup-in">
                                    {["Prepaid", "COD"].map((type) => (
                                        <div
                                            ...
                                            className="px-3 py-2 text-[12px] font-[600] text-gray-500 hover:bg-blue-50 hover:text-[#0192ED] cursor-pointer transition-colors"
                                        >
                                            {type}
                                        </div>
                                    ))}
                    ...
                    <div className="space-y-1" ref={pickupRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} ${showPickupDropdown ? "border-[#0192ED]" : "border-gray-200"} bg-white`}
                            >
                                ...
                                <div className="absolute top-[105%] left-0 w-full bg-white border border-gray-100 rounded-lg shadow-xl z-10 py-1 animate-popup-in max-h-60 overflow-y-auto">
                                    <div className="sticky top-0 bg-white px-2 py-1 border-b">
                                        <input
                                            ...
                                            className="w-full px-2 py-1 text-[11px] border rounded focus:outline-none focus:border-[#0192ED]"
                                            value={pickupSearch}
                                        ...
                                        .map((addr, idx) => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className="px-3 py-2 text-[12px] font-[600] text-gray-500 hover:bg-blue-50 hover:text-[#0192ED] cursor-pointer transition-colors flex items-center gap-2"
                                                >
                                                    <input type="checkbox" checked={isSelected} readOnly className="accent-[#0192ED] w-3 h-3" />
                        ...
                        <div className="space-y-1" ref={courierRef}>
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className={`${fieldStyle} ${showCourierDropdown ? "border-[#0192ED]" : "border-gray-200"} bg-white`}
                                >
                ...
                <div className="p-4 border-t bg-white flex gap-3">
                    ...
                    <button
                        onClick={handleApply}
                        className="flex-1 py-2 bg-[#0192ED] text-white rounded-lg text-[12px] font-[600] hover:bg-opacity-90 transition-all shadow-sm active:scale-[0.98]"
                    >
                        Apply Filters
                    </button>
                </div>
