                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <input
                            ...
                            className={`${fieldStyle} bg-white border border-gray-300 text-gray-700 placeholder:text-gray-400 focus:outline-none focus:border-[#0192ED]`}
                    ...
                    <div className="space-y-1" ref={kycRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} ${showKycDropdown ? "border-[#0192ED]" : "border-gray-300"} bg-white`}
                            >
                    ...
                    <div className="space-y-1" ref={rateCardRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} ${showRateCardDropdown ? "border-[#0192ED]" : "border-gray-300"} bg-white`}
                            >
                    ...
                    <div className="space-y-1" ref={walletRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} ${showWalletDropdown ? "border-[#0192ED]" : "border-gray-300"} bg-white`}
                            >
