            ...
            <tbody>
                        ...
                        >
                            ...
                            {showUserDetails && (
                                <td className="py-2 text-gray-700 px-3 whitespace-nowrap" style={{ maxWidth: "120px", width: "110px" }}>
                                    <p className="text-[#0192ED]">{order.userId?.userId}</p>
                            ...
                            >
                               ...
                               text-gray-500 hover:text-[#0192ED]"
                                        >
                                ...
                                <div className="flex gap-2 items-center justify-start">
                                    {/* CHANNEL BADGE */}
                                    <p className="uppercase text-[10px] leading-none text-[#0192ED] bg-blue-100 py-0.5 px-2 rounded w-fit">
                ...
                whitespace-normal select-text pointer-events-auto"
                            ...
                            <td className="py-2 px-3">
                                ...
                                <span className="text-[10px] bg-blue-100 text-[#0192ED] px-2 py-0.5 rounded">
                 ...
                 whitespace-normal break-words leading-relaxed"
                                ...
                                >
                                    ...
                                    {order.awb_number && (
                                        <div className="relative inline-flex items-center group">
                                            <p
                                                className="text-[12px] text-[#0192ED] cursor-pointer pr-5"
                                                onClick={() =>
                     ...
                     text-gray-500 hover:text-[#0192ED]"
                       ...
                       px-2 py-1 rounded whitespace-nowrap"
                            ...
                            <td className="py-2 px-3 whitespace-nowrap">
                                <span className={`px-2 py-0.5 rounded text-[10px] ${order.status === "Cancelled" ? "bg-red-100 text-red-600" : "bg-blue-100 text-[#0192ED]"}`}>{order.status}</span>
                            </td>
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <div className="relative inline-block group">
                                                {/* Trigger */}
                                                <span
                                                    className="text-[10px] border-b border-dashed border-[#0192ED] 
               ...
               select-text pointer-events-auto"
                                            ...
                                            <button
                                                ...
                                                className="text-[10px] bg-[#0192ED] text-white px-2 py-0.5 rounded hover:bg-opacity-90 transition-all font-[600]"
                                            >
                                                History
                                            </button>
                                        </div>
                            ...
                            {showNdrAction && (
                                <td className="py-2 px-3 text-center">
                                    <button
                                        ...
                                        className="bg-[#0192ED] text-white px-3 py-1.5 rounded-lg text-[10px] font-[600] hover:bg-opacity-90 transition-all shadow-sm w-full"
                                    >
                                        Take Action
                                    </button>
                                </td>
