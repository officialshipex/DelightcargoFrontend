                    ...
                    <div className="space-y-1" ref={monthRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} border bg-white ${showMonthDropdown ? "border-[#0192ED]" : "border-gray-300"}`}
                            >
                            ...
                            {showMonthDropdown && (
                                <div className="absolute top-[105%] left-0 w-full bg-white border border-gray-100 rounded-lg shadow-xl z-20 py-1 animate-popup-in max-h-48 overflow-y-auto">
                                    <div
                                        ...
                                        className="px-3 py-2 text-[12px] font-[600] text-gray-500 hover:bg-blue-50 hover:text-[#0192ED] cursor-pointer"
                                    >
                                        All Months
                                    </div>
                                    {months.map((m) => (
                    ...
                    <div className="space-y-1" ref={yearRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} border bg-white ${showYearDropdown ? "border-[#0192ED]" : "border-gray-300"}`}
                            >
