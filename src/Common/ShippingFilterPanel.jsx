                    ...
                    <div className="space-y-1" ref={searchTypeRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} border bg-white ${showSearchTypeDropdown ? "border-[#0192ED]" : "border-gray-300"}`}
                            >
                    ...
                    <div className="space-y-1" ref={statusRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`border ${fieldStyle} ${showStatusDropdown ? "border-[#0192ED]" : "border-gray-300"} bg-white`}
                            >
