...
const WalletHistoryFilterPanel = ({
    ...
    }, [isOpen, initialSelectedUserId, initialTransactionId, initialPaymentId, initialStatus]);
                    ...
                    <div className="space-y-1" ref={statusRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} ${showStatusDropdown ? "border-[#0192ED]" : "border-gray-300"} bg-white`}
                            >
