                    ...
                    <div className="space-y-1" ref={monthRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} ${showMonthDropdown ? "border-[#0192ED]" : "border-gray-300"} bg-white`}
                            >
                    ...
                    <div className="space-y-1" ref={yearRef}>
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`${fieldStyle} ${showYearDropdown ? "border-[#0192ED]" : "border-gray-300"} bg-white`}
                            >
