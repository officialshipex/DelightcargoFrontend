...
export default function CustomDropdown({ label, options = [], value, onChange, name, placeholder = "Select" }) {
    ...
    return (
        <div ref={dropdownRef} className="relative w-full text-[10px] sm:text-[12px] flex flex-col gap-1.5">
            ...
            <div
                className={`border bg-white cursor-pointer px-3 sm:h-[35px] h-[33px] font-[600] rounded-lg flex justify-between items-center transition-all ${isOpen ? "border-[#0192ED] ring-1 ring-[#0192ED]/20" : "border-gray-300 hover:border-gray-300"}`}
