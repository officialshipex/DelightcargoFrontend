                ...
                <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <div className="flex items-center gap-2 group">
                            <h1 className="sm:text-[14px] text-[12px] font-[600] text-gray-700">
                                Pickup ID# <span className="text-[#0192ED]">{manifest?.pickupId || pickupId}</span>
                            </h1>
                            <div
                        ...
                        <span className="px-2 font-[600] py-1 rounded text-[10px] bg-blue-100 text-[#0192ED] uppercase">
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="flex items-center gap-1 px-3 py-2 bg-[#0192ED] text-white text-[10px] font-[600] rounded-lg shadow-sm hover:bg-opacity-90"
                        >
                            Download Manifest
                        </button>
                    </div>
                    ...
                    <div className="hidden md:block relative" ref={desktopActionRef}>
                        ...
                        {desktopDropdownOpen && (
                            <div className="absolute right-0 mt-1 w-48 text-[10px] bg-white border border-gray-200 shadow-xl z-[60] font-[600] overflow-hidden animate-popup-in">
                                <ul className="">
                                    <li className="px-3 py-2 text-gray-700 hover:bg-blue-50 cursor-pointer" onClick={() => { ExportExcel({ selectedOrders, orders }); setDesktopDropdownOpen(false); }}>Export Excel</li>
                                    <li className="px-3 py-2 text-gray-700 hover:bg-blue-50 cursor-pointer" onClick={() => { handleBulkDownloadInvoice({ selectedOrders }); setDesktopDropdownOpen(false); }}>Download Invoices</li>
                                    <li className="px-3 py-2 text-gray-700 hover:bg-blue-50 cursor-pointer" onClick={() => { handleBulkDownloadManifests(selectedOrders); setDesktopDropdownOpen(false); }}>Download Manifests</li>
                                    <li className="px-3 py-2 text-gray-700 hover:bg-blue-50 cursor-pointer" onClick={() => { handleBulkDownloadLabel({ selectedOrders }); setDesktopDropdownOpen(false); }}>Download Labels</li>
                                </ul>
                            </div>
                        )}
                    </div>
