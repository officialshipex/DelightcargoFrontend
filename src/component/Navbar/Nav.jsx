...
import DelightCargoLogo from "../../assets/DelightCargo.jpg"; // adjust path as needed
...
const Navbar = () => {
  ...
  return (
    <div className={localStorage.getItem("admin_token_backup") ? "pb-[88px] sm:pb-[92px]" : "pb-[55px] sm:pb-[60px]"}>
      ...
      <div className={`w-full bg-white shadow fixed left-0 right-0 z-50 ${localStorage.getItem("admin_token_backup") ? "top-[32px]" : "top-0"}`}>
        <div className="flex items-center justify-end gap-2 px-3 py-1.5 min-h-[55px] sm:min-h-[60px]">
          ...
          <div className="flex items-center justify-center">
            <button className="text-[12px] hidden lg:block lg:ml-0 text-[#0192ED]">
              <img
                src={grouplogo}
                alt="description"
          ...
          <div className="sm:flex hidden sm:flex-1 justify-start lg:justify-start sm:ml-4 ml-2">
            <img src={DelightCargoLogo} alt="Logo" className="h-9" />
          </div>

          <div className="sm:hidden">
            <button
              onClick={() => setShowQuickPopup(true)}
              className="flex items-center justify-center w-8 h-8 rounded-full bg-[#0192ED] text-white hover:bg-blue-50 transition"
            >
      ...
      "
              ...
              >
                ...
                <div className={`grid gap-3 text-center animate-popup-in text-gray-700 ${userData?.isAdmin ? 'grid-cols-2' : 'grid-cols-3'}`}>
                  ...
                  <div
                    ...
                    className="flex flex-col items-center justify-center bg-gray-50 border border-[#0192ED] rounded-lg py-3 cursor-pointer hover:bg-gray-100 transition"
                  >
                    <div className="bg-[#E1F7F2] p-2 rounded-full text-[#0192ED] text-[12px]">
                      <FiPlusSquare />
                    </div>
          ...
          <div className="lg:hidden flex gap-4">
            <div className="relative">
              <div
                className={`flex items-center justify-center space-x-2 h-8 px-3 rounded-lg shadow-sm w-fit border ${balance < 0 ? "border-red-500 bg-red-50" : "border-[#0192ED] bg-white"
                  }`}
              >
                <FaWallet
                  className={`${balance < 0 ? "text-red-500" : "text-[#0192ED]"
                    } text-[10px]`}
                  title="Wallet Info"
                />

                <span
                  className={`text-[10px] font-[600] leading-none flex items-center space-x-1 select-none cursor-pointer ${balance < 0 ? "text-red-500" : "text-[#0192ED]"
                    }`}
                ...
                >
                  ...
                  <FaCaretDown
                    className={`text-[10px] transition-transform ${isBalanceDropdownOpen ? "rotate-180" : "rotate-0"
                      } ${balance < 0 ? "text-red-500" : "text-[#0192ED]"}`}
                  />
                </span>

                <div
                  className={`w-4 h-4 rounded-full flex justify-center items-center ${balance < 0 ? "bg-red-500" : "bg-[#0192ED]"
                    }`}
                >
                  <FaPlus
                ...
                <FaSyncAlt
                  className={`text-[10px] cursor-pointer hover:text-gray-500 transition-transform duration-500 ${balance < 0 ? "text-red-500" : "text-[#0192ED]"
                    }`}
            ...
            >
              <FaEllipsisV className="text-[14px] text-[#0192ED]" />
            </button>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <div className="relative inline-block text-left" ref={quickDropdownRef}>
              ...
              <button
                ...
                className={`flex text-gray-500 items-center gap-1 px-3 h-8 rounded-lg border border-[#0192ED] hover:opacity-90 text-[12px] font-[600] ${showActions ? "bg-white" : "bg-transparent"
                  }`}
              >
                <FiZap className="text-[#0192ED]" />
                Quick Actions
              </button>
                ...
                <div className={`absolute left-1/2 -translate-x-1/2 mt-3 z-50 ${userData?.isAdmin ? 'w-[620px]' : 'w-[500px]'}`}>
                  <div className="bg-white animate-popup-in border border-gray-200 rounded-lg shadow-sm px-3 py-2 w-full">
                    ...
                    <div className={`grid gap-2 ${userData?.isAdmin ? 'grid-cols-4' : 'grid-cols-3'}`}>
                      ...
                      className="flex flex-col items-center justify-center bg-gray-50 rounded-lg py-4 cursor-pointer hover:bg-gray-100 transition"
                    >
                      <div className="bg-[#e1f7f2] p-2 rounded-full text-[#0192ED] text-xl">
                        <FaTicketAlt />
                      </div>
      ...
      ${balance < 0 ? "bg-red-500" : "bg-[#0192ED]"}`}
              >
        ...
        ${balance < 0 ? "bg-white" : "bg-white"}`}
          ...
          ${balance < 0 ? "text-red-500 hover:text-red-400" : "text-[#0192ED] hover:text-blue-500"}`}
                    title="Recharge wallet"
                    onClick={handleRechargeWallet}
                  />
                </div>
      ...
      ${balance < 0 ? "bg-red-500" : "bg-[#0192ED]"}`}
        ...
        ${balance < 0 ? "text-white" : "text-white"}`}
            ...
            {/* User Initial */}
            <div
              className="profile-icon w-8 h-8 bg-[#0192ED] text-white flex items-center justify-center rounded-full font-[600] cursor-pointer overflow-hidden"
              onClick={(e) => {
                e.stopPropagation();
          ...
          <ul className="space-y-4 text-[12px] font-[600]">
            ...
            <li>
              <button
                ...
                className="text-gray-700 flex items-center gap-2"
              >
                <FiCreditCard className="text-[#0192ED]" />
                Recharge Wallet
              </button>
            </li>
            ...
            {userData?.isAdmin && (
              <li className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-gray-700">
                  <FiShield className="text-[#0192ED]" />
      ...
      {isDropdownOpen && (
        ...
        >
          <ul>
            ...
            {/* Profile */}
            <li className="hover:bg-blue-50 p-2">
              <Link
                to="/dashboard/settings/company-profile"
                className="text-gray-700 flex items-center gap-2"
            ...
            {/* Admin/User Toggle */}
            {userData?.isAdmin && (
              <li className="hover:bg-blue-50 p-2 flex items-center justify-between">
                <div className="flex items-center gap-2 text-gray-700">
                  <FiShield className="text-[#0192ED]" />
                  <span>{isAdminTab ? "Admin" : "User"}</span>
                </div>
                ...
                <label className="relative inline-flex items-center w-11 h-6 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => handleToggleAdmin(e.target.checked)}
                  />
                  <div className="w-10 h-5 bg-gray-300 rounded-full peer-checked:bg-[#0192ED] transition-all duration-300"></div>
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-[#E1F7F2] rounded-full flex items-center justify-center">
                  <FiUserCheck className="text-[#0192ED] text-[16px]" />
                </div>
                <div>
            ...
            <div className="relative" ref={userLoginSearchRef}>
              <div className="flex items-center gap-2 border border-gray-200 rounded-xl px-3 py-2.5 bg-gray-50 focus-within:border-[#0192ED] focus-within:bg-white transition">
                <FiSearch className="text-[#0192ED] text-[14px] flex-shrink-0" />
                <input
                  type="text"
                  autoFocus
                ...
                />
                {userSearchLoading && (
                  <svg className="animate-spin h-4 w-4 text-[#0192ED] flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              ...
              {userSuggestions.length > 0 && (
                <div className="absolute left-0 right-0 top-full mt-1 bg-white border border-gray-100 rounded-xl shadow-lg z-50 overflow-y-auto max-h-[300px] custom-scrollbar">
                  {userSuggestions.map((u) => (
                    ...
                    >
                      {/* Avatar */}
                      <div className="w-8 h-8 rounded-full bg-[#0192ED] text-white text-[12px] font-[700] flex items-center justify-center flex-shrink-0">
                      ...
                      {/* Company badge */}
                      {u.company && (
                        <span className="text-[10px] font-[600] bg-blue-50 text-[#0192ED] px-2 py-0.5 rounded-full flex-shrink-0 truncate max-w-[90px]">
                          {u.company}
                        </span>
                      )}
                      {/* Open icon */}
                      {userLoginLoading ? (
                        <svg className="animate-spin h-3.5 w-3.5 text-[#0192ED] flex-shrink-0" fill="none" viewBox="0 0 24 24">
                          <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
                          <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
                        </svg>
                      ) : (
