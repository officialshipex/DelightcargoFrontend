          ...
          renderDetails={(order, index) => (
            <div className="flex justify-center w-full">
              <button
                ...
                className="text-[#0192ED] font-[600] text-[12px] underline hover:bg-opacity-90 transition"
              >
                Details
              </button>
            </div>
          ...
          renderActions={(order, index) => (
            <div className="flex flex-col gap-1 items-center justify-center w-full">
              <button
                ...
                className="w-16 bg-[#0192ED] text-white px-2 py-1 rounded-lg text-[10px] hover:bg-opacity-90 transition disabled:opacity-50"
                disabled={!canAction}
              >
                Accept
              </button>
          ...
          <SharedWeightDiscrepancyCard
            ...
            renderBottomActions={(order, index) => (
              <div className="px-3 py-2 bg-gray-50 flex justify-between items-center border-t">
                <button
                  onClick={() => handleOpenModal(order.text, order.imageUrl)}
                  className="bg-[#0192ED] text-white px-3 py-1 rounded-md text-[10px]"
                >
                  Details
                </button>
                <div className="flex gap-2">
                  <button
                    onClick={() => handleOpenPopup(order.awbNumber)}
                    className="bg-[#0192ED] text-white px-3 py-1 rounded-md text-[10px] disabled:opacity-50"
                    disabled={!canAction}
                  >
                    Accept
                  </button>
