...
const WeightDiscrepancy = ({ isSidebarAdmin }) => {
    ...
    return (
            ...
            {(isSidebarAdmin || employeeAccess.canView || employeeAccess.isAdmin) && (
                <>
                    ...
                    <div className="w-full">
                        ...
                        <div className="md:hidden bg-white border border-[#0192ED] rounded-lg px-3 py-2 text-[10px] text-gray-700 space-y-1">
                            {[
                        ...
                        <div className="hidden md:grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2">
                            {[
                                ...
                                >
                                    <div className="p-2 bg-[#0192ED] rounded-full flex items-center justify-center">
                                        {item.icon}
                                    </div>
                                    <div>
      ...
      ${isSidebarAdmin || employeeAccess.canAction
                                        ? "text-[#0192ED] bg-white border-[#0192ED] hover:bg-blue-50"
                                        : "text-gray-400 bg-gray-100 border-gray-300 cursor-not-allowed"
                                    }`}
                            >
                                <FaUpload className="text-[#0192ED]" />
                                <span>Upload</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="relative w-full md:hidden mb-2 mt-2 flex gap-2">
                        ...
                        {showDropdown && (
                            <div className="absolute top-full w-full left-0 mt-1 animate-popup-in text-gray-700 bg-white border rounded-lg font-[600] shadow-lg z-10">
                                {tabs.map((tab) => (
                                    <button
                                        key={tab}
                                        className={`w-full text-left px-3 py-2 text-[12px] hover:bg-blue-100 ${activeTab === tab ? "bg-blue-100" : "hover:bg-blue-50"}`}
                                        onClick={() => {
                                            setActiveTab(tab);
                        ...
                        <div className="h-[34px] px-3 bg-[#0192ED] rounded-lg flex items-center justify-center cursor-pointer">
