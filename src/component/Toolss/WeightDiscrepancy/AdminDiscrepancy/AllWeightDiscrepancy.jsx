...
const AllWeightDiscrepancy = () => {
  ...
  useEffect(() => {
    fetchDiscrepancy();
  }, [selectedUserId, dateRange, page, limit, inputValue, searchBy, selectedCourier, status]);
  ...
  const isAnyFilterApplied = inputValue || selectedCourier.length > 0 || dateRange || selectedUserId || status;
...
export default AllWeightDiscrepancy;
