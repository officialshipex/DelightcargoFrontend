                ...
                orders.map((order, index) => {
                    ...
                    return (
                        <div key={index} className="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden text-[10px]">
                                ...
                                <div className="flex items-center gap-2 flex-wrap">
                                    ...
                                    <div className="flex items-center gap-1">
                                        <span className="font-[600] text-gray-700 text-[10px]">
                                            Order Id : <span className="font-[600] text-[#0192ED]">{order.channelOrderId || order.orderId || order._id?.slice(-6)}</span>
                                        </span>
                            ...
                            {/* SHIPMENT DETAILS */}
                            <div className="px-3 py-1 flex justify-between items-center bg-blue-50">
                                {/* Left Side */}
                                <div className="flex items-center gap-2">
                                    ...
                                    <div className="flex flex-col text-[10px]">
                                        ...
                                        <div className="flex items-center gap-1">
                                            <span onClick={() => handleTrackingByAwb(order.awbNumber)} className="text-[#0192ED] font-[600] cursor-pointer">
                                                {order.awbNumber}
                                            </span>
                                ...
                                {/* Right Side Amount */}
                                <div className="text-[#0192ED] font-[600] text-[10px]">
