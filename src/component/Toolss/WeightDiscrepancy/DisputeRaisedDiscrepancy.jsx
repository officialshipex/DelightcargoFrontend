...
const DisputeRaisedDiscrepancy = () => {
    ...
    const handleExportExcel = () => {
        ...
        saveAs(blob, "dispute_raised_discrepancies.xlsx");
    };
        ...
        <div>
            ...
            <div className="w-full">
                ...
                <SharedWeightDiscrepancyTable
                    ...
                    renderActions={(order) => (
                        <span
                            className="text-[#0192ED] hover:underline cursor-pointer font-[600] text-[12px]"
                ...
                <div className="block md:hidden">
                    ...
                    <div className="space-y-2 h-[calc(100vh-250px)] overflow-y-auto">
                        <SharedWeightDiscrepancyCard
                            ...
                            renderActions={(order) => (
                                <span
                                    className="text-[#0192ED] cursor-pointer hover:underline font-[600] text-[10px] whitespace-nowrap"
                                    onClick={() => handleOpenModal(order.text, order.imageUrl)}
                                >
                                    View Details
                                </span>
