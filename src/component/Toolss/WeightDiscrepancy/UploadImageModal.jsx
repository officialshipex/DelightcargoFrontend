            ...
            <div className="bg-white p-6 rounded-lg shadow-sm w-[500px] relative animate-popup-in border border-gray-100">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea
                            className="w-full border border-gray-200 rounded-xl placeholder:text-[11px] text-[11px] sm:text-[13px] text-gray-700 p-3 focus:outline-none focus:ring-2 focus:ring-[#0192ED]/20 focus:border-[#0192ED] transition-all min-h-[100px]"
                    ...
                    <div className="space-y-2">
                        ...
                        <label className="group cursor-pointer block relative">
                            <div className={`
                                ...
                                ${file ? 'border-[#0192ED] bg-blue-50/30' : 'border-gray-200 hover:border-[#0192ED] hover:bg-gray-50'}
                            `}>
                                <div className={`p-3 rounded-full mb-2 transition-colors ${file ? 'bg-[#0192ED] text-white' : 'bg-gray-100 text-gray-400 group-hover:bg-blue-50 group-hover:text-[#0192ED]'}`}>
                                    <FaUpload size={14} />
                                </div>
                ...
                <div className="flex justify-between items-center mt-8 gap-3">
                    <button
                        onClick={onClose}
                        className="flex items-center justify-center bg-gray-50 border border-gray-200 px-4 py-2 rounded-lg gap-2 text-[10px] sm:text-[12px] font-bold text-gray-600 hover:text-[#0192ED] hover:border-[#0192ED] hover:bg-blue-50 transition-all"
                    >
                        Cancel
                    </button>
                    <button
                        className={`flex py-2 px-6 bg-[#0192ED] text-white rounded-lg text-[10px] sm:text-[12px] font-bold hover:opacity-90 transition-all flex items-center justify-center gap-2 shadow-lg shadow-green-100 ${loading ? "opacity-50 cursor-not-allowed" : ""
                            }`}
