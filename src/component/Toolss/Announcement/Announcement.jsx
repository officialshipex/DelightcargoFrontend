      ...
      <div className="w-full mx-auto flex flex-col flex-1">
        ...
        <div className="flex flex-row justify-between items-center mb-2 gap-2">
          ...
          <button
            ...
            className="bg-[#0192ED] text-white px-3 py-2 rounded-lg text-[12px] font-[600] flex items-center gap-2 hover:bg-opacity-90 transition-all shadow-sm active:scale-[0.98]"
          >
        ...
        <div className="bg-white overflow-hidden flex-1 flex flex-col hidden sm:block">
          <div className="overflow-auto flex-1 h-[calc(100vh-160px)]">
            <table className="min-w-full text-left border-collapse">
              <thead className="bg-[#0192ED] text-white font-[600] sticky top-0 z-10">
                    ...
                    <tr key={ann._id} className="border-b border-gray-300 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-3 py-2">
                        <label className="relative inline-flex items-center cursor-pointer">
                          ...
                          />
                          <div className="w-9 h-5 bg-gray-300 rounded-full peer peer-checked:bg-[#0192ED] transition-all"></div>
                      ...
                      <td className="px-3 py-2">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="p-1 text-white hover:text-gray-100 hover:bg-blue-600 rounded-full bg-[#0192ED] transition shadow-sm"
                            title="Edit"
                          >
                  ...
                  <div className="flex items-center gap-3">
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        ...
                        onChange={() => toggleEnable(ann)}
                      />
                      <div className="w-8 h-4 bg-gray-300 rounded-full peer peer-checked:bg-[#0192ED] transition-all"></div>
                    ...
                    <div className="flex items-center gap-1.5 border-l pl-2">
                       <button onClick={() => handleEdit(ann)} className="p-1.5 text-[#0192ED] hover:bg-blue-50 rounded-full transition-all">
                         <AiOutlineEdit size={16} />
                       </button>
            ...
            <div className="relative w-full max-w-[450px] bg-white h-full shadow-2xl flex flex-col animate-slide-in-right">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-5">
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full border border-gray-300 rounded-lg p-3 text-[12px] font-[600] text-gray-700 focus:outline-none focus:border-[#0192ED] transition-all h-28 resize-none shadow-sm"
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    ...
                    />
                    <div className="w-11 h-6 bg-gray-300 rounded-full peer peer-checked:bg-[#0192ED] transition-all"></div>
                    ...
                    <label className="flex items-center gap-2 cursor-pointer group">
                      <div className="relative flex items-center justify-center">
                        <input
                          ...
                          className="sr-only"
                        />
                        <div className={`w-4 h-4 rounded-full border-2 transition-all ${targetAudience === "all" ? "border-[#0192ED]" : "border-gray-300 group-hover:border-gray-400"}`}>
                          <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-[#0192ED] transition-transform ${targetAudience === "all" ? "scale-100" : "scale-0"}`}></div>
                        </div>
                      </div>
                    ...
                    <label className="flex items-center gap-2 cursor-pointer group">
                      <div className="relative flex items-center justify-center">
                        <input
                          ...
                          className="sr-only"
                        />
                        <div className={`w-4 h-4 rounded-full border-2 transition-all ${targetAudience === "selected" ? "border-[#0192ED]" : "border-gray-300 group-hover:border-gray-400"}`}>
                          <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-[#0192ED] transition-transform ${targetAudience === "selected" ? "scale-100" : "scale-0"}`}></div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2 max-h-40 overflow-y-auto custom-scrollbar pr-1">
                        {selectedUsers.length > 0 ? (
                          selectedUsers.map(user => (
                            <div key={user._id} className="flex items-center justify-between p-2 bg-white border border-gray-200 rounded-lg text-[11px] hover:border-[#0192ED] transition-colors">
                    ...
                    <label className="flex items-center gap-2 cursor-pointer group">
                      <div className="relative flex items-center justify-center">
                        <input
                          ...
                          className="sr-only"
                        />
                        <div className={`w-4 h-4 rounded-full border-2 transition-all ${disableType === "manual" ? "border-[#0192ED]" : "border-gray-300 group-hover:border-gray-400"}`}>
                          <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-[#0192ED] transition-transform ${disableType === "manual" ? "scale-100" : "scale-0"}`}></div>
                        </div>
                      </div>
                    ...
                    <label className="flex items-center gap-2 cursor-pointer group">
                      <div className="relative flex items-center justify-center">
                        <input
                          ...
                          className="sr-only"
                        />
                        <div className={`w-4 h-4 rounded-full border-2 transition-all ${disableType === "automated" ? "border-[#0192ED]" : "border-gray-300 group-hover:border-gray-400"}`}>
                          <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-[#0192ED] transition-transform ${disableType === "automated" ? "scale-100" : "scale-0"}`}></div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <select
                            ...
                            className="w-full bg-white border border-gray-300 rounded-lg p-2 text-[12px] font-[600] text-gray-700 focus:outline-none focus:border-[#0192ED] appearance-none shadow-sm"
                          >
                      ...
                      {automatedDuration === "custom" && (
                        <div className="animate-popup-in">
                          ...
                          <input
                            ...
                            className="w-full bg-white border border-gray-300 rounded-lg p-2 text-[12px] font-[600] text-gray-700 focus:outline-none focus:border-[#0192ED] shadow-sm"
                          />
                        </div>
                      )}
                    </div>
              ...
              <div className="p-4 border-t bg-white flex gap-3 shadow-top">
                ...
                <button
                  ...
                  className="flex-1 py-2 bg-[#0192ED] text-white rounded-lg text-[12px] font-[600] hover:bg-opacity-90 transition-all shadow-sm active:scale-[0.98] flex items-center justify-center gap-2"
                >
