            ...
            <div className="sm:bg-white mx-auto w-full border bg-white rounded-lg sm:shadow-sm p-2 sm:p-4 flex flex-col md:flex-row">
                ...
                <div className="space-y-4 w-full md:w-1/2 pr-0 md:pr-8">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full border rounded-lg px-3 py-2 text-[12px] font-[600] text-gray-700 outline-none focus:ring-1 focus:ring-[#0192ED]"
                            />
                        </div>
                                ...
                                <div className="absolute z-10 w-full bg-white border rounded-lg mt-1 text-[12px] shadow-lg overflow-hidden">
                                    {["ROV Owner", "ROV Carrier"].map((v) => (
                                        <div
                                            ...
                                            className={`px-3 py-2 hover:bg-blue-50 cursor-pointer font-[600] text-gray-700 transition-colors ${form.rovType === v ? "bg-blue-100" : ""
                                                }`}
                                        >
                                            {v}
                                        </div>
                                ...
                                <div className="absolute z-10 w-full bg-white border rounded-lg mt-1 text-[12px] shadow-lg overflow-hidden">
                                    {["Prepaid", "COD"].map((v) => (
                                        <div
                                            ...
                                            className={`px-3 py-2 hover:bg-blue-50 cursor-pointer font-[600] text-gray-700 transition-colors ${form.paymentType === v ? "bg-blue-100" : ""
                                                }`}
                                        >
                                            {v}
                                        </div>
                    ...
                    {packages.map((pkg, idx) => (
                        <div
                            key={pkg.id}
                            className="border border-dashed border-[#0192ED] rounded-lg p-4 relative"
                        >
                            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#0192ED] text-white w-6 h-6 rounded-full flex items-center justify-center text-[12px] font-[600]">
                                {idx + 1}
                            </div>
                    ...
                    <div className="flex justify-center">
                        <button
                            onClick={addPackage}
                            className="w-7 h-7 rounded-full bg-[#0192ED] text-white flex items-center justify-center font-[600] hover:opacity-90 transition-all"
                        >
                            +
                        </button>
                    </div>
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="bg-[#0192ED] text-white text-[12px] font-[600] py-2 px-3 rounded-lg hover:opacity-90 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
                        {loading ? (
                            <>
