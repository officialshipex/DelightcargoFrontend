        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              ...
              <div className="flex items-center w-full rounded-lg overflow-hidden">
                ...
                />
                <span className="w-10 py-2 flex items-center justify-center bg-[#0192ED] text-white text-[12px] font-[600] border border-l border-[#0192ED] rounded-r-lg">
                  kg
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              <div
                ...
                className="flex justify-between items-center w-full border rounded-lg px-3 py-2 text-[12px] font-[600] text-gray-700 cursor-pointer focus:ring-1 focus:ring-[#0192ED]"
              >
                ...
                <div className="absolute z-10 left-0 right-0 bg-white mt-1 border border-gray-300 rounded-lg transition-all duration-200 text-[12px] overflow-hidden font-[600] text-gray-700 shadow-lg">
                  {["Prepaid", "COD"].map((option) => (
                    <div
                      ...
                      className={`px-3 py-2 cursor-pointer hover:bg-blue-50 transition-colors ${formData.paymentType === option
                        ? "bg-blue-100 font-[600]"
                        : ""
                        }`}
                    >
                      {option}
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Length"
                  className="w-full border rounded-lg px-2 py-2 text-[12px] font-[600] text-gray-700 outline-none focus:ring-1 focus:ring-[#0192ED]"
                />
                <input
                  type="number"
          ...
          <div className="flex justify-start">
            <button
              type="submit"
              disabled={loading}
              className="bg-[#0192ED] text-[12px] text-white font-[600] py-2 px-3 rounded-lg hover:opacity-90 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {loading ? (
                <>
