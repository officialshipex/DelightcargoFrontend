          ...
          <div className="hidden md:block bg-white shadow rounded-lg p-4">
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b text-left bg-[#0192ED] text-white font-[600] text-[12px]">
            ...
            {plan.map((item) => (
              ...
              >
                ...
                <div className="mt-2 flex justify-center">
                  {item.orderType === "B2C" && (
                    <Link to="/dashboard/b2c/order">
                      <button className="w-full py-2 px-3 bg-[#0192ED] text-white rounded-lg text-[10px] font-[600] hover:opacity-90 transition-all">
                        + Create Shipment
                      </button>
                    </Link>
                  )}
