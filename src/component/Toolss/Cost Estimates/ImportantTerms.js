...
const ImportantTerms = () => {
  const terms = [
    ...
    "Detailed terms and conditions can be reviewed on <span style='color: blue;'>DelightCargo's Terms of services</span>.",
    "For any queries reach out to us at https://carrier.delightcargo.in/support or write to us at <a href='mailto:support@delightcargo.in' style='color: blue; text-decoration: underline;'>support@delightcargo.in</a>."
  ];

  return (
  <div className="bg-blue-50 p-4 md:p-4 lg:p-4 rounded-lg shadow-md mx-auto lg:shadow-[0_2px_8px_rgba(12,187,125,0.3)]">
