        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-blue-50/50 border border-blue-100 rounded-xl p-4 space-y-3">
              <h3 className="text-[10px] sm:text-[12px] font-bold text-[#0192ED] uppercase tracking-wider flex items-center gap-2">
              ...
              <div className="space-y-2 text-[10px] sm:text-[12px]">
                ...
                <div className="flex justify-between border-b border-blue-100 pb-1">
                  ...
                  <span className="font-bold text-[#0192ED]">{referral.userId || "-"}</span>
                </div>
            ...
            <div className="bg-blue-50/50 border border-blue-100 rounded-xl p-4 space-y-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div className="text-center p-2 bg-white rounded-lg border border-blue-100">
                  ...
                  <p className="text-[10px] sm:text-[12px] font-bold text-[#0192ED]">₹{Math.round(referral.totalShipping || 0)}</p>
                </div>
                <div className="text-center p-2 bg-white rounded-lg border border-blue-100">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <h3 className="text-[12px] sm:text-[14px] font-bold text-gray-700 flex items-center gap-2">
                <Users className="w-4 h-4 text-[#0192ED]" />
            ...
            <div className="overflow-hidden">
              <div className="max-h-[400px] overflow-y-auto">
                <table className="sm:w-full w-[500px] text-[12px] border-collapse bg-white">
                  <thead className="bg-[#0192ED] text-white font-bold sticky top-0 z-10">
                    <tr>
                      ...
                      referral.subUsers.map((sub, idx) => (
                        <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                          <td className="px-3 py-2">
                            <p className="font-bold text-[#0192ED]">{sub.userId}</p>
                          ...
                          <td className="px-3 py-2 text-right font-bold text-[#0192ED]">
