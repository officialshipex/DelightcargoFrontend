      ...
      <div className="relative w-full max-w-[450px] bg-white h-full shadow-2xl flex flex-col animate-slide-in-right transform transition-transform duration-300">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          {type === "Email" && (
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-xl text-[13px] font-medium focus:outline-none focus:ring-2 focus:ring-[#0192ED]/20 focus:border-[#0192ED] transition-all"
              />
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 bg-white border border-gray-300 rounded-xl text-[13px] font-medium focus:outline-none focus:ring-2 focus:ring-[#0192ED]/20 focus:border-[#0192ED] transition-all resize-none leading-relaxed"
            />
          </div>

          {/* Variables Helper */}
          <div className="space-y-3 p-4 bg-blue-50/50 rounded-2xl border border-blue-100">
            <div className="flex items-center gap-2 text-[#0192ED]">
            ...
            <div className="flex flex-wrap gap-2">
              {variables.map((v) => (
                <button
                  ...
                  className="px-2.5 py-1.5 bg-white border border-blue-200 text-[#0192ED] text-[11px] font-bold rounded-lg hover:bg-[#0192ED] hover:text-white hover:border-[#0192ED] transition-all shadow-sm"
        ...
        <div className="p-6 border-t bg-gray-50 flex gap-4">
          ...
          <button
            ...
            className="flex-1 py-2.5 bg-[#0192ED] text-white rounded-xl text-[13px] font-bold hover:bg-[#0aa36d] transition-all shadow-lg shadow-[#0192ED]/20 active:scale-[0.98]"
          >
            Save Changes
          </button>
        </div>
