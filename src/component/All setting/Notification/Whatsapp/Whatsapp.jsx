...
const Whatsapp = () => {
  ...
  const statuses = [
    ...
    { key: "Cancelled", label: "Cancelled", defaultTemplate: "Your order {order_id} has been cancelled as per request. Team DelightCargo." },
  ];
        ...
        <div className="flex items-center bg-white p-2 w-full justify-between rounded-lg border border-gray-100 shadow-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <Switch
              ...
              className={`${mainEnabled ? "bg-[#0192ED]" : "bg-gray-300"
      ...
      <div className="hidden sm:block bg-white overflow-hidden">
        <div className="h-[calc(100vh-220px)] overflow-y-auto custom-scrollbar">
          <table className="min-w-full text-[12px] border-collapse">
            <thead className="bg-[#0192ED] text-white sticky top-0 z-10 shadow-sm">
              <tr>
                ...
                >
                  ...
                  <td className="px-3 py-2 text-center">
                    <button 
                      ...
                      className="text-[10px] text-[#0192ED] font-bold hover:bg-blue-50 px-3 py-2 border border-blue-100 rounded-lg transition-all"
                    >
                      Edit
                    </button>
                  </td>
          ...
          >
            <div className="flex justify-between items-center mb-2">
              ...
              <Switch
                ...
                onChange={() => handleToggle(status.key)}
                disabled={!mainEnabled || loading}
                className={`${statusToggles[status.key] ? "bg-[#0192ED]" : "bg-gray-300"
            ...
            <div className="flex justify-between items-center">
              ...
              <button 
                onClick={() => openEditModal(status)}
                className="text-[#0192ED] font-bold text-[12px] px-4 py-1.5 border border-blue-100 rounded-lg shadow-sm"
              >
                Edit
              </button>
            </div>
