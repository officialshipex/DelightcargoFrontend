              ...
              {settingsCards.map((item, idx) => {
                ...
                return (
                  <Link
                    key={idx}
                    to={item.link}
                    className="group flex flex-row sm:flex-col items-center sm:items-center justify-start sm:justify-center gap-3 sm:gap-2 text-gray-700 font-[400] h-auto sm:h-24 p-3 border-2 border-[#0192ED] rounded-md bg-white hover:bg-[#0192ED] hover:text-white shadow-sm hover:shadow-md transition-all duration-200"
                  >
                    <div className="w-8 h-8 flex-shrink-0 rounded bg-[#0192ED] flex items-center justify-center transition-all group-hover:bg-white">
                      <Icon className="text-white group-hover:text-[#0192ED] text-[16px] transition-all" />
                    </div>
