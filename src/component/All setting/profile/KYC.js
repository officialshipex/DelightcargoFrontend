    ...
    <div className="">
      <div className="w-full mx-auto">
        ...
        <div className="mt-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2">
          {/* Aadhar Details */}
          <div className={`px-3 py-2 border border-[#0192ED] bg-white rounded-lg shadow-sm`}>
            <div className="flex items-center justify-between">
              <h2 className="text-[12px] sm:text-[14px] font-[600] text-gray-700">
                Aadhaar Details
              </h2>
              {isVerified_A ? (
                <div className="flex items-center text-[#0192ED]">
          ...
          {/* Bank Details */}
          <div className="px-3 py-2 border border-[#0192ED] rounded-lg bg-white shadow-sm">
            <div className="flex items-center justify-between">
              <h2 className="text-[12px] sm:text-[14px] font-[600] text-gray-700">
                Bank Details
              </h2>
          ...
          {/* GST Details */}
          <div className="px-3 py-2 border border-[#0192ED] rounded-lg shadow-sm bg-white">
            <div className="flex items-center justify-between">
              <h2 className="text-[12px] sm:text-[14px] font-[600] text-gray-700">
                GST Details
              </h2>
