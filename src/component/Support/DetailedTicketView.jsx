    ...
    <div className="overflow-y-auto z-50 md:p-2 flex flex-col">
      <div className="w-full mx-auto bg-white rounded-lg p-2 md:p-4 flex-1 flex flex-col">
        ...
        <div className="flex items-center gap-2 mb-4">
          <button
            onClick={onClose}
            className="text-[#0192ED] hover:text-[#099e67] sm:text-[18px] text-[16px]"
          >
            <IoArrowBack />
          </button>
          <h2 className="sm:text-[18px] text-[14px] font-[600] text-[#0192ED]">Ticket Details</h2>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between mt-6 gap-2 sm:gap-0">
          ...
          <div className="flex gap-2 sm:gap-3 flex-col sm:flex-row">
            <button
              className="px-3 py-2 h-9 rounded-lg bg-[#0192ED] text-white font-[600] sm:text-[12px] text-[10px] hover:bg-blue-600"
