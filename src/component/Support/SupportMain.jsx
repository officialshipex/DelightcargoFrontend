    ...
    <div className="">
      <div className="md:p-2 p-2 w-full mx-auto">
        ...
        <p className="text-center text-gray-700 text-[12px] md:text-[14px] mt-2">
          ...
          | Email:
          <a
            href="mailto:support@delightcargo.com"
            className="text-gray-700 font-[600]"
          >
            support@delightcargo.com
          </a>
        </p>
        ...
        <div className="md:hidden flex flex-col items-center mt-4">
          <div className="flex gap-2">
            <button
              className="flex items-center gap-1 px-3 py-2 bg-[#0192ED] text-white text-[10px] sm:text-[12px] font-[600] rounded-lg hover:bg-blue-500 transition"
            ...
            <>
              ...
              <div className="hidden md:block overflow-x-auto">
                <table className="min-w-full bg-white border border-gray-200">
                  <thead>
                    <tr className="bg-[#0192ED] text-white text-[12px] font-[600] border border-gray-200">
