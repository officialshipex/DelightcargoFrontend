...
const InputField = ({ label, icon: Icon, ...props }) => (
  <div className="flex flex-col gap-1">
    <label className="text-[10px] sm:text-[12px] font-[600] text-gray-700 flex items-center gap-1.5">
      {/* {Icon && <Icon className="w-3 h-3 text-[#0192ED]" />} */}
      {label}
    </label>
    <input
      {...props}
      className="w-full border border-gray-300 px-3 py-2 text-[12px] font-[500] text-gray-700 rounded-lg focus:outline-none focus:border-[#0192ED] focus:ring-1 focus:ring-[#0192ED]/20 transition-all placeholder:text-gray-400"
    />
  </div>
);
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-gray-50/50 shrink-0">
          <div>
            ...
            <p className="text-[10px] text-gray-500 font-[500]">
              AWB: <span className="text-[#0192ED] font-[600]">{order.awb_number}</span>
        ...
        <div className="overflow-y-auto p-4 flex flex-col gap-3 custom-scrollbar">
          ...
          <div className="flex flex-col gap-1" ref={dropdownRef}>
            ...
            <button
              ...
              className="w-full border border-gray-300 px-3 py-2 text-[12px] font-[600] text-gray-700 rounded-lg text-left flex justify-between items-center hover:border-[#0192ED] transition-all focus:outline-none focus:border-[#0192ED]"
            >
              ...
              <ul className="absolute z-30 mt-16 bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden animate-popup-in text-[12px] w-[calc(100%-2rem)] max-w-[calc(28rem-2rem)]">
                {ACTIONS.map(({ label, value }) => (
                  <li
                    ...
                    className={`px-3 py-2 cursor-pointer font-[600] transition-colors flex items-center gap-2 ${action === value ? "bg-blue-50 text-[#0192ED]" : "text-gray-700 hover:bg-gray-50"}`}
                  >
                    {value === "RE-ATTEMPT"}
          ...
          {action && (
            <div className="flex flex-col gap-1">
              <label className="text-[10px] sm:text-[12px] font-[600] text-gray-700 flex items-center gap-1.5">
                {/* <MessageSquare className="w-3 h-3 text-[#0192ED]" /> */}
              ...
              <textarea
                ...
                className="w-full border border-gray-300 px-3 py-2 text-[12px] font-[500] text-gray-700 rounded-lg focus:outline-none focus:border-[#0192ED] focus:ring-1 focus:ring-[#0192ED]/20 transition-all placeholder:text-gray-400 resize-none"
              />
            </div>
          )}
          ...
          {needsChangeAddressFields && (
            <div className="border border-[#0192ED]/20 rounded-lg p-3 bg-blue-50/30 flex flex-col gap-2.5">
              <p className="text-[11px] font-[700] text-[#0192ED] flex items-center gap-1.5">
          ...
          {action && needsScheduledDate && (
            <div className="flex flex-col gap-1">
              <label className="text-[10px] sm:text-[12px] font-[600] text-gray-700 flex items-center gap-1.5">
                <Calendar className="w-3 h-3 text-[#0192ED]" />
              ...
              <input
                ...
                className="w-full border border-gray-300 px-3 py-2 rounded-lg text-[12px] text-gray-700 focus:outline-none focus:border-[#0192ED] focus:ring-1 focus:ring-[#0192ED]/20 transition-all"
              />
            </div>
          )}
          ...
          {isEcomExpress && (isReattempt || isChangeAddress) && (
            <div className="flex flex-col gap-1">
              ...
              <select
                ...
                className="w-full border border-gray-300 px-3 py-2 rounded-lg text-[12px] text-gray-700 font-[600] focus:outline-none focus:border-[#0192ED] focus:ring-1 focus:ring-[#0192ED]/20 transition-all"
              >
        ...
        <div className="flex justify-end items-center gap-2 px-4 py-3 border-t border-gray-100 bg-gray-50/30 shrink-0">
          ...
          <button
            ...
            className={`px-3 py-2 text-white font-[600] text-[12px] rounded-lg transition-all ${loading || !action
              ...
              : "bg-[#0192ED] hover:bg-[#099c68] active:scale-95 shadow-sm shadow-[#0192ED]/20"
              }`}
          >
            {loading ? (
